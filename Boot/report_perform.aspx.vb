...
Partial Class report_perform
    ...
    Protected Sub SearchBt_Click(sender As Object, e As System.EventArgs) Handles SearchBt.Click
        Try
            ...
            Dim htmlHead As String = "<div style='font-weight:bold'>Boots Retail (Thailand) Ltd.</div><div style='font-weight:bold'>" + ddlBy.SelectedValue + " {0} &nbsp;&nbsp;&nbsp;&nbsp;Currency Rate " + ddlRate.SelectedItem.Text + " </div>"
    ...
    Protected Sub gv_RowDataBound(sender As Object, e As System.Web.UI.WebControls.GridViewRowEventArgs) Handles gv.RowDataBound
        ...
        If e.Row.RowType = DataControlRowType.DataRow Then
            ...
            If e.Row.DataItem("TradingProfit") < 0 Then
                e.Row.Cells(gv.Columns.Count - 2).Text = String.Format("<span style='color:red'>({0})</span>", clsPfm.convert2TradingProfit(e.Row.DataItem("TradingProfit").ToString))
            Else
                e.Row.Cells(gv.Columns.Count - 2).Text = clsPfm.convert2TradingProfit(e.Row.DataItem("TradingProfit").ToString)
            End If
    ...
    Private Sub createCels(color As String, fontBold As Boolean, ByVal e As GridViewRowEventArgs, str As String)
        Try
            ...
            creatCels.Add("13", "" + str.Split(strSplit)(12) + "|1|1")
            creatCels.Add("14", "" + str.Split(strSplit)(13) + "|1|1")
