<%@ Page Title="" Language="VB" MasterPageFile="~/MasterPage.master" AutoEventWireup="false" CodeFile="manage_province.aspx.vb" Inherits="manage_province" %>
...
<ContentTemplate>
    ...
    <div><strong>Manage Province</strong><br /><br /></div>
    <div><asp:Button ID="AddNewBt" runat="server" Text="Add New Province" /></div>
    <asp:Panel ID="Panel1" runat="server">
     ...
     <asp:Panel ID="Panel2" runat="server">
            <div style="padding-top:10px;">
                <asp:Label ID="Label2" runat="server" CssClass="lbtitle" Text="Edit"></asp:Label> <asp:TextBox ID="EditTxt" runat="server" CssClass="inputbox4"></asp:TextBox><asp:Button ID="EditBt" runat="server" Text="Update" /><asp:HiddenField ID="HdID" runat="server" />
            </div>
    </asp:Panel>
    <div style="padding-top:10px;">
        ...
        <asp:ObjectDataSource ID="ObjectDataSource1" runat="server" 
            SelectMethod="getProvinceOname" TypeName="ClsDB"></asp:ObjectDataSource>
        <br />
    </div>
</div>
</ContentTemplate>
