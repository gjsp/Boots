...
Partial Class area_report_ytd
   ...
   "<TR style='font-weight:bold;' class='kbg1'><TD align='center'><div style='width:110px'><strong>Area " + e.Item.DataItem("area_name") + "</strong></div></TD><TD align='center'><div style='width:65px;'><strong>% Sale</strong></div></TD></TR>" + _
