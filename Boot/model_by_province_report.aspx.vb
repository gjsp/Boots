...
Partial Class model_by_province_report
    Inherits basePage
    Protected Sub Page_Load(ByVal sender As Object, ByVal e As System.EventArgs) Handles Me.Load
        If Not Page.IsPostBack Then
            ...
            ddlprovince.Items.Add(New ListItem("All", "ALL"))
    ...
    Protected Sub SearchBt_Click(ByVal sender As Object, ByVal e As System.EventArgs) Handles SearchBt.Click
        ...
        'LbSumTradingProfit__Loss.Text = 0
            ...
            ObjectDataSource2.SelectParameters("province").DefaultValue = ddlprovince.SelectedValue
    ...
    Protected Sub DataList2_ItemDataBound(ByVal sender As Object, ByVal e As System.Web.UI.WebControls.DataListItemEventArgs) Handles DataList2.ItemDataBound
        ...
        CType(e.Item.FindControl("ttext"), HtmlGenericControl).InnerHtml = "<TABLE cellspacing='0' cellpadding='0' class='tball'>" + _
