...
Partial Class compare_area_report_mtd
    Inherits basePage
    ...
    Protected Sub SearchBt_Click(ByVal sender As Object, ByVal e As System.EventArgs) Handles SearchBt.Click
		...
		LbNostUP.Text = 0
			...
			LbMtdDate.Text = MonthName(ddlMonth.SelectedValue, True).ToString + " " + ddlYear.SelectedValue.ToString()
            LbFullTgs.Text = 0
            LbFullTss.Text = 0
            LbFullPos.text = 0
			...
			LbBKKMtdDate.Text = MonthName(ddlMonth.SelectedValue, True).ToString + " " + ddlYear.SelectedValue.ToString()
            LbBKKFullTgs.Text = 0
            LbBKKFullTss.Text = 0
            LbBKKFullPos.text = 0
			...
			LbUPMtdDate.Text = MonthName(ddlMonth.SelectedValue, True).ToString + " " + ddlYear.SelectedValue.ToString()
            LbUPFullTgs.Text = 0
            LbUPFullTss.Text = 0
            LbUPFullPos.text = 0
        ...
        ObjectDataSource2.SelectParameters("locate").DefaultValue = ""
        ObjectDataSource2.SelectParameters("rate").DefaultValue = ddlRate.SelectedValue
            ...
            LbPercMarginAdjustments.Text = ClsManage.convert2Currency((Convert.ToDecimal(LbSumMarginAdjustments.Text) / Convert.ToDecimal(LbSumTotalRevenue.Text)) * 100).ToString
                ...
                LbFullPos.Text = ClsManage.convert2Currency(Convert.ToDecimal(LbSumTotalRevenue.Text) / Convert.ToDecimal(LbFullTss.Text)).ToString
		End If
		...
		If LbBKKSumTotalRevenue.Text <> 0 Then
                ...
                LbBKKFullPos.Text = ClsManage.convert2Currency(Convert.ToDecimal(LbBKKSumTotalRevenue.Text) / Convert.ToDecimal(LbBKKFullTss.Text)).ToString
		End If
		...
		If LbUPSumTotalRevenue.Text <> 0 Then
                ...
                LbUPFullPos.Text = ClsManage.convert2Currency(Convert.ToDecimal(LbUPSumTotalRevenue.Text) / Convert.ToDecimal(LbUPFullTss.Text)).ToString
    ...
    Protected Sub DataList2_ItemDataBound(ByVal sender As Object, ByVal e As System.Web.UI.WebControls.DataListItemEventArgs) Handles DataList2.ItemDataBound
        ...
        da = ClsDB.getSumMFulltdModelByBangkok(ddlYear.SelectedValue, ddlMonth.SelectedValue, "1", e.Item.DataItem("store_id").ToString, ddlRate.SelectedValue)

        Dim da2 As Data.DataTable
        da2 = ClsDB.getSumMFulltdModelByBangkok(ddlYear.SelectedValue, ddlMonth.SelectedValue, "2", e.Item.DataItem("store_id").ToString, ddlRate.SelectedValue)

        Dim prosqm As String = "0.0"
        If e.Item.DataItem("sumsalearea") - da.Rows(0)("sumsalearea") <> "0" Then
            prosqm = ClsManage.convert2Currency3((e.Item.DataItem("sumTotalRevenue") - da.Rows(0)("sumTotalRevenue")) / (e.Item.DataItem("sumsalearea") - da.Rows(0)("sumsalearea"))).ToString()
        End If
        ...
        End If
          ...
          CType(e.Item.FindControl("label2"), Label).Text = "<TABLE cellspacing='0' cellpadding='0' class='tball' style='border-right:2px solid #000000;'>" + _
                                                      "<TR style='font-weight:bold;' class='kbg1'><TD align='center'><div style='width:110px'><strong>" + da.Rows(0)("cnum").ToString + "</strong></div></TD><TD align='center' valign='middle'><div style='width:65px;'><strong></strong></div></TD><TD align='center'><div style='width:110px'><strong>" + ClsManage.convert2Currency3(e.Item.DataItem("cnum") - da.Rows(0)("cnum")).ToString + "</strong></div></TD><TD align='center' valign='middle'><div style='width:65px;'><strong></strong></div></TD></TR>" + _
                                                      "<TR style='font-weight:bold;' class='kbg1'><TD align='center' style='height:30px;'><div style='width:110px'><strong>" + e.Item.DataItem("store_name") + " (Bangkok)</strong></div></TD><TD align='center' valign='middle'><div style='width:65px;'><strong>% Sale</strong></div></TD><TD align='center'><div style='width:110px'><strong>" + e.Item.DataItem("store_name") + " (Upcountry)</strong></div></TD><TD align='center' valign='middle'><div style='width:65px;'><strong>% Sale</strong></div></TD></TR>" + _
                                                      "<TR style='font-weight:bold;'><TD align='center'><div style='width:110px'>" + ClsManage.convert2Currency3(da.Rows(0)("sumtotalarea")).ToString + "</div></TD><TD align='center'><div style='width:65px;'>&nbsp;</div></TD><TD align='center'><div style='width:110px'>" + ClsManage.convert2Currency3(e.Item.DataItem("sumtotalarea") - da.Rows(0)("sumtotalarea")).ToString + "</div></TD><TD align='center'><div style='width:65px;'>&nbsp;</div></TD></TR>" + _
                                                      "<TR style='font-weight:bold;'><TD align='center'><div style='width:110px'>" + ClsManage.convert2Currency3(da.Rows(0)("sumsalearea")).ToString + "</div></TD><TD align='center'><div style='width:65px;'>&nbsp;</div></TD><TD align='center'><div style='width:110px'>" + ClsManage.convert2Currency3(e.Item.DataItem("sumsalearea") - da.Rows(0)("sumsalearea")).ToString + "</div></TD><TD align='center'><div style='width:65px;'>&nbsp;</div></TD></TR>" + _
                                                      "<TR style='font-weight:bold;'><TD align='center'><div style='width:110px'>" + ClsManage.convert2Currency3(da.Rows(0)("sumTotalRevenue") / da.Rows(0)("sumsalearea")).ToString + "</div></TD><TD align='center'><div style='width:65px;'>&nbsp;</div></TD><TD align='center'><div style='width:110px'>" + prosqm + "</div></TD><TD align='center'><div style='width:65px;'>&nbsp;</div></TD></TR>" + _
                                                        "<TR style='font-weight:bold;'><TD align='center'><div style='width:110px'>" + MonthName(ddlMonth.SelectedValue, True).ToString + " " + ddlYear.SelectedValue.ToString() + "</div></TD><TD align='center'><div style='width:65px;'>&nbsp;</div></TD><TD align='center'><div style='width:110px'>" + MonthName(ddlMonth.SelectedValue, True).ToString + " " + ddlYear.SelectedValue.ToString() + "</div></TD><TD align='center'><div style='width:65px;'>&nbsp;</div></TD></TR>" + _
 "<TR style='font-weight:bold;' class='kbg5'><TD align='right'><div style='width:110px'>" + ClsManage.convert2Currency3(da.Rows(0)("sumTotalRevenue")).ToString + "</div></TD><TD align='right'><div style='width:65px;'>100.0%</div></TD><TD align='right'><div style='width:110px'>" + ClsManage.convert2Currency3(e.Item.DataItem("sumTotalRevenue") - da.Rows(0)("sumTotalRevenue")).ToString + "</div></TD><TD align='right'><div style='width:65px;'>100.0%</div></TD></TR>" + _
"<TR id='aa1c" + TbCk.Text + "'><TD align='right'><div style='width:110px'>" + ClsManage.convert2Currency3(da.Rows(0)("sumRETAIL_TESPIncome")).ToString + "</div></TD><TD align='right'><div style='width:65px;'>" + ClsManage.convert2Currency4((da.Rows(0)("sumRETAIL_TESPIncome") / da.Rows(0)("sumTotalRevenue")) * 100).ToString + "%</div></TD><TD align='right'><div style='width:110px'>" + ClsManage.convert2Currency3(e.Item.DataItem("sumRETAIL_TESPIncome") - da.Rows(0)("sumRETAIL_TESPIncome")).ToString + "</div></TD><TD align='right'><div style='width:65px;'>" + ClsManage.convert2PercenNoneZero(e.Item.DataItem("sumRETAIL_TESPIncome") - da.Rows(0)("sumRETAIL_TESPIncome"), e.Item.DataItem("sumTotalRevenue") - da.Rows(0)("sumTotalRevenue")).ToString + "%</div></TD></TR>" + _
"<TR id='aa2c" + TbCk.Text + "'><TD align='right'><div style='width:110px'>" + ClsManage.convert2Currency3(da.Rows(0)("sumOtherRevenue")).ToString + "</div></TD><TD align='right'><div style='width:65px;'>" + ClsManage.convert2Currency4((da.Rows(0)("sumOtherRevenue") / da.Rows(0)("sumTotalRevenue")) * 100).ToString + "%</div></TD><TD align='right'><div style='width:110px'>" + ClsManage.convert2Currency3(e.Item.DataItem("sumOtherRevenue") - da.Rows(0)("sumOtherRevenue")).ToString + "</div></TD><TD align='right'><div style='width:65px;'>" + ClsManage.convert2PercenNoneZero(e.Item.DataItem("sumOtherRevenue") - da.Rows(0)("sumOtherRevenue"), e.Item.DataItem("sumTotalRevenue") - da.Rows(0)("sumTotalRevenue")).ToString + "%</div></TD></TR>" + _
"<TR style='font-weight:bold;'><TD align='right'><div style='width:110px'>" + ClsManage.convert2Currency3(da.Rows(0)("sumCostofGoodSold")).ToString + "</div></TD><TD align='right'><div style='width:65px;'>" + ClsManage.convert2Currency4((da.Rows(0)("sumCostofGoodSold") / da.Rows(0)("sumTotalRevenue")) * 100).ToString + "%</div></TD><TD align='right'><div style='width:110px'>" + ClsManage.convert2Currency3(e.Item.DataItem("sumCostofGoodSold") - da.Rows(0)("sumCostofGoodSold")).ToString + "</div></TD><TD align='right'><div style='width:65px;'>" + ClsManage.convert2PercenNoneZero(e.Item.DataItem("sumCostofGoodSold") - da.Rows(0)("sumCostofGoodSold"), e.Item.DataItem("sumTotalRevenue") - da.Rows(0)("sumTotalRevenue")).ToString + "%</div></TD></TR>" + _
"<TR style='font-weight:bold;' class='kbg5'><TD align='right'><div style='width:110px'>" + ClsManage.convert2Currency3(da.Rows(0)("sumGrossProfit")).ToString + "</div></TD><TD align='right'><div style='width:65px;'>" + ClsManage.convert2Currency4((da.Rows(0)("sumGrossProfit") / da.Rows(0)("sumTotalRevenue")) * 100).ToString + "%</div></TD><TD align='right'><div style='width:110px'>" + ClsManage.convert2Currency3(e.Item.DataItem("sumGrossProfit") - da.Rows(0)("sumGrossProfit")).ToString + "</div></TD><TD align='right'><div style='width:65px;'>" + ClsManage.convert2PercenNoneZero(e.Item.DataItem("sumGrossProfit") - da.Rows(0)("sumGrossProfit"), e.Item.DataItem("sumTotalRevenue") - da.Rows(0)("sumTotalRevenue")).ToString + "%</div></TD></TR>" + _
"<TR style='font-weight:bold;'><TD align='right'><div style='width:110px'>" + ClsManage.convert2Currency3(da.Rows(0)("sumMarginAdjustments")).ToString + "</div></TD><TD align='right'><div style='width:65px;'>" + ClsManage.convert2Currency4((da.Rows(0)("sumMarginAdjustments") / da.Rows(0)("sumTotalRevenue")) * 100).ToString + "%</div></TD><TD align='right'><div style='width:110px'>" + ClsManage.convert2Currency3(e.Item.DataItem("sumMarginAdjustments") - da.Rows(0)("sumMarginAdjustments")).ToString + "</div></TD><TD align='right'><div style='width:65px;'>" + ClsManage.convert2PercenNoneZero(e.Item.DataItem("sumMarginAdjustments") - da.Rows(0)("sumMarginAdjustments"), e.Item.DataItem("sumTotalRevenue") - da.Rows(0)("sumTotalRevenue")).ToString + "%</div></TD></TR>" + _
"<TR id='b1c" + TbCk.Text + "'><TD align='right'><div style='width:110px'>" + ClsManage.convert2Currency3(da.Rows(0)("sumShipping")).ToString + "</div></TD><TD align='right'><div style='width:65px;'>" + ClsManage.convert2Currency4((da.Rows(0)("sumShipping") / da.Rows(0)("sumTotalRevenue")) * 100).ToString + "%</div></TD><TD align='right'><div style='width:110px'>" + ClsManage.convert2Currency3(e.Item.DataItem("sumShipping") - da.Rows(0)("sumShipping")).ToString + "</div></TD><TD align='right'><div style='width:65px;'>" + ClsManage.convert2PercenNoneZero(e.Item.DataItem("sumShipping") - da.Rows(0)("sumShipping"), e.Item.DataItem("sumTotalRevenue") - da.Rows(0)("sumTotalRevenue")).ToString + "%</div></TD></TR>" + _
...
"<TR id='b9c" + TbCk.Text + "'><TD align='right'><div style='width:110px'>" + ClsManage.convert2Currency3(da.Rows(0)("sumGWPs_Transferred")).ToString + "</div></TD><TD align='right'><div style='width:65px;'>" + ClsManage.convert2Currency4((da.Rows(0)("sumGWPs_Transferred") / da.Rows(0)("sumTotalRevenue")) * 100).ToString + "%</div></TD><TD align='right'><div style='width:110px'>" + ClsManage.convert2Currency3(e.Item.DataItem("sumGWPs_Transferred") - da.Rows(0)("sumGWPs_Transferred")).ToString + "</div></TD><TD align='right'><div style='width:65px;'>" + ClsManage.convert2PercenNoneZero(e.Item.DataItem("sumGWPs_Transferred") - da.Rows(0)("sumGWPs_Transferred"), e.Item.DataItem("sumTotalRevenue") - da.Rows(0)("sumTotalRevenue")).ToString + "%</div></TD></TR>" + _
"<TR id='b10c" + TbCk.Text + "'><TD align='right'><div style='width:110px'>" + ClsManage.convert2Currency3(da.Rows(0)("sumSellingCosts")).ToString + "</div></TD><TD align='right'><div style='width:65px;'>" + ClsManage.convert2Currency4((da.Rows(0)("sumSellingCosts") / da.Rows(0)("sumTotalRevenue")) * 100).ToString + "%</div></TD><TD align='right'><div style='width:110px'>" + ClsManage.convert2Currency3(e.Item.DataItem("sumSellingCosts") - da.Rows(0)("sumSellingCosts")).ToString + "</div></TD><TD align='right'><div style='width:65px;'>" + ClsManage.convert2PercenNoneZero(e.Item.DataItem("sumSellingCosts") - da.Rows(0)("sumSellingCosts"), e.Item.DataItem("sumTotalRevenue") - da.Rows(0)("sumTotalRevenue")).ToString + "%</div></TD></TR>" + _
"<TR id='b11c" + TbCk.Text + "'><TD align='right'><div style='width:110px'>" + ClsManage.convert2Currency3(da.Rows(0)("sumCreditcardscommission")).ToString + "</div></TD><TD align='right'><div style='width:65px;'>" + ClsManage.convert2Currency4((da.Rows(0)("sumCreditcardscommission") / da.Rows(0)("sumTotalRevenue")) * 100).ToString + "%</div></TD><TD align='right'><div style='width:110px'>" + ClsManage.convert2Currency3(e.Item.DataItem("sumCreditcardscommission") - da.Rows(0)("sumCreditcardscommission")).ToString + "</div></TD><TD align='right'><div style='width:65px;'>" + ClsManage.convert2PercenNoneZero(e.Item.DataItem("sumCreditcardscommission") - da.Rows(0)("sumCreditcardscommission"), e.Item.DataItem("sumTotalRevenue") - da.Rows(0)("sumTotalRevenue")).ToString + "%</div></TD></TR>" + _
"<TR id='b12c" + TbCk.Text + "'><TD align='right'><div style='width:110px'>" + ClsManage.convert2Currency3(da.Rows(0)("sumLabellingMaterial")).ToString + "</div></TD><TD align='right'><div style='width:65px;'>" + ClsManage.convert2Currency4((da.Rows(0)("sumLabellingMaterial") / da.Rows(0)("sumTotalRevenue")) * 100).ToString + "%</div></TD><TD align='right'><div style='width:110px'>" + ClsManage.convert2Currency3(e.Item.DataItem("sumLabellingMaterial") - da.Rows(0)("sumLabellingMaterial")).ToString + "</div></TD><TD align='right'><div style='width:65px;'>" + ClsManage.convert2PercenNoneZero(e.Item.DataItem("sumLabellingMaterial") - da.Rows(0)("sumLabellingMaterial"), e.Item.DataItem("sumTotalRevenue") - da.Rows(0)("sumTotalRevenue")).ToString + "%</div></TD></TR>" + _
"<TR id='b13c" + TbCk.Text + "'><TD align='right'><div style='width:110px'>" + ClsManage.convert2Currency3(da.Rows(0)("sumOtherIncome_COSHFunding")).ToString + "</div></TD><TD align='right'><div style='width:65px;'>" + ClsManage.convert2Currency4((da.Rows(0)("sumOtherIncome_COSHFunding") / da.Rows(0)("sumTotalRevenue")) * 100).ToString + "%</div></TD><TD align='right'><div style='width:110px'>" + ClsManage.convert2Currency3(e.Item.DataItem("sumOtherIncome_COSHFunding") - da.Rows(0)("sumOtherIncome_COSHFunding")).ToString + "</div></TD><TD align='right'><div style='width:65px;'>" + ClsManage.convert2PercenNoneZero(e.Item.DataItem("sumOtherIncome_COSHFunding") - da.Rows(0)("sumOtherIncome_COSHFunding"), e.Item.DataItem("sumTotalRevenue") - da.Rows(0)("sumTotalRevenue")).ToString + "%</div></TD></TR>" + _
"<TR id='b14c" + TbCk.Text + "''><TD align='right'><div style='width:110px'>" + ClsManage.convert2Currency3(da.Rows(0)("sumOtherIncomeSupplier")).ToString + "</div></TD><TD align='right'><div style='width:65px;'>" + ClsManage.convert2Currency4((da.Rows(0)("sumOtherIncomeSupplier") / da.Rows(0)("sumTotalRevenue")) * 100).ToString + "%</div></TD><TD align='right'><div style='width:110px'>" + ClsManage.convert2Currency3(e.Item.DataItem("sumOtherIncomeSupplier") - da.Rows(0)("sumOtherIncomeSupplier")).ToString + "</div></TD><TD align='right'><div style='width:65px;'>" + ClsManage.convert2PercenNoneZero(e.Item.DataItem("sumOtherIncomeSupplier") - da.Rows(0)("sumOtherIncomeSupplier"), e.Item.DataItem("sumTotalRevenue") - da.Rows(0)("sumTotalRevenue")).ToString + "%</div></TD></TR>" + _
"<TR style='font-weight:bold;' class='kbg5'><TD align='right'><div style='width:110px'>" + ClsManage.convert2Currency3(da.Rows(0)("sumAdjustedGrossMargin")).ToString + "</div></TD><TD align='right'><div style='width:65px;'>" + ClsManage.convert2Currency4((da.Rows(0)("sumAdjustedGrossMargin") / da.Rows(0)("sumTotalRevenue")) * 100).ToString + "%</div></TD><TD align='right'><div style='width:110px'>" + ClsManage.convert2Currency3(e.Item.DataItem("sumAdjustedGrossMargin") - da.Rows(0)("sumAdjustedGrossMargin")).ToString + "</div></TD><TD align='right'><div style='width:65px;'>" + ClsManage.convert2PercenNoneZero(e.Item.DataItem("sumAdjustedGrossMargin") - da.Rows(0)("sumAdjustedGrossMargin"), e.Item.DataItem("sumTotalRevenue") - da.Rows(0)("sumTotalRevenue")).ToString + "%</div></TD></TR>" + _
"<TR style='font-weight:bold;'><TD align='right'><div style='width:110px'>" + ClsManage.convert2Currency3(da.Rows(0)("sumSupplyChainCosts")).ToString + "</div></TD><TD align='right'><div style='width:65px;'>" + ClsManage.convert2Currency4((da.Rows(0)("sumSupplyChainCosts") / da.Rows(0)("sumTotalRevenue")) * 100).ToString + "%</div></TD><TD align='right'><div style='width:110px'>" + ClsManage.convert2Currency3(e.Item.DataItem("sumSupplyChainCosts") - da.Rows(0)("sumSupplyChainCosts")).ToString + "</div></TD><TD align='right'><div style='width:65px;'>" + ClsManage.convert2PercenNoneZero(e.Item.DataItem("sumSupplyChainCosts") - da.Rows(0)("sumSupplyChainCosts"), e.Item.DataItem("sumTotalRevenue") - da.Rows(0)("sumTotalRevenue")).ToString + "%</div></TD></TR>" + _
"<TR style='font-weight:bold;' class='kbg5'><TD align='right'><div style='width:110px'>" + ClsManage.convert2Currency3(da.Rows(0)("sumTotalStoreExpenses")).ToString + "</div></TD><TD align='right'><div style='width:65px;'>" + ClsManage.convert2Currency4((da.Rows(0)("sumTotalStoreExpenses") / da.Rows(0)("sumTotalRevenue")) * 100).ToString + "%</div></TD><TD align='right'><div style='width:110px'>" + ClsManage.convert2Currency3(e.Item.DataItem("sumTotalStoreExpenses") - da.Rows(0)("sumTotalStoreExpenses")).ToString + "</div></TD><TD align='right'><div style='width:65px;'>" + ClsManage.convert2PercenNoneZero(e.Item.DataItem("sumTotalStoreExpenses") - da.Rows(0)("sumTotalStoreExpenses"), e.Item.DataItem("sumTotalRevenue") - da.Rows(0)("sumTotalRevenue")).ToString + "%</div></TD></TR>" + _
"<TR style='font-weight:bold;'><TD align='right'><div style='width:110px'>" + ClsManage.convert2Currency3(da.Rows(0)("sumStoreLabourCosts")).ToString + "</div></TD><TD align='right'><div style='width:65px;'>" + ClsManage.convert2Currency4((da.Rows(0)("sumStoreLabourCosts") / da.Rows(0)("sumTotalRevenue")) * 100).ToString + "%</div></TD><TD align='right'><div style='width:110px'>" + ClsManage.convert2Currency3(e.Item.DataItem("sumStoreLabourCosts") - da.Rows(0)("sumStoreLabourCosts")).ToString + "</div></TD><TD align='right'><div style='width:65px;'>" + ClsManage.convert2PercenNoneZero(e.Item.DataItem("sumStoreLabourCosts") - da.Rows(0)("sumStoreLabourCosts"), e.Item.DataItem("sumTotalRevenue") - da.Rows(0)("sumTotalRevenue")).ToString + "%</div></TD></TR>" + _
"<TR id='e1c" + TbCk.Text + "'><TD align='right'><div style='width:110px'>" + ClsManage.convert2Currency3(da.Rows(0)("sumGrossPay")).ToString + "</div></TD><TD align='right'><div style='width:65px;'>" + ClsManage.convert2Currency4((da.Rows(0)("sumGrossPay") / da.Rows(0)("sumTotalRevenue")) * 100).ToString + "%</div></TD><TD align='right'><div style='width:110px'>" + ClsManage.convert2Currency3(e.Item.DataItem("sumGrossPay") - da.Rows(0)("sumGrossPay")).ToString + "</div></TD><TD align='right'><div style='width:65px;'>" + ClsManage.convert2PercenNoneZero(e.Item.DataItem("sumGrossPay") - da.Rows(0)("sumGrossPay"), e.Item.DataItem("sumTotalRevenue") - da.Rows(0)("sumTotalRevenue")).ToString + "%</div></TD></TR>" + _
"<TR id='e2c" + TbCk.Text + "'><TD align='right'><div style='width:110px'>" + ClsManage.convert2Currency3(da.Rows(0)("sumTemporaryStaffCosts")).ToString + "</div></TD><TD align='right'><div style='width:65px;'>" + ClsManage.convert2Currency4((da.Rows(0)("sumTemporaryStaffCosts") / da.Rows(0)("sumTotalRevenue")) * 100).ToString + "%</div></TD><TD align='right'><div style='width:110px'>" + ClsManage.convert2Currency3(e.Item.DataItem("sumTemporaryStaffCosts") - da.Rows(0)("sumTemporaryStaffCosts")).ToString + "</div></TD><TD align='right'><div style='width:65px;'>" + ClsManage.convert2PercenNoneZero(e.Item.DataItem("sumTemporaryStaffCosts") - da.Rows(0)("sumTemporaryStaffCosts"), e.Item.DataItem("sumTotalRevenue") - da.Rows(0)("sumTotalRevenue")).ToString + "%</div></TD></TR>" + _
"<TR id='e3c" + TbCk.Text + "'><TD align='right'><div style='width:110px'>" + ClsManage.convert2Currency3(da.Rows(0)("sumAllowance")).ToString + "</div></TD><TD align='right'><div style='width:65px;'>" + ClsManage.convert2Currency4((da.Rows(0)("sumAllowance") / da.Rows(0)("sumTotalRevenue")) * 100).ToString + "%</div></TD><TD align='right'><div style='width:110px'>" + ClsManage.convert2Currency3(e.Item.DataItem("sumAllowance") - da.Rows(0)("sumAllowance")).ToString + "</div></TD><TD align='right'><div style='width:65px;'>" + ClsManage.convert2PercenNoneZero(e.Item.DataItem("sumAllowance") - da.Rows(0)("sumAllowance"), e.Item.DataItem("sumTotalRevenue") - da.Rows(0)("sumTotalRevenue")).ToString + "%</div></TD></TR>" + _
"<TR id='e4c" + TbCk.Text + "'><TD align='right'><div style='width:110px'>" + ClsManage.convert2Currency3(da.Rows(0)("sumOvertime")).ToString + "</div></TD><TD align='right'><div style='width:65px;'>" + ClsManage.convert2Currency4((da.Rows(0)("sumOvertime") / da.Rows(0)("sumTotalRevenue")) * 100).ToString + "%</div></TD><TD align='right'><div style='width:110px'>" + ClsManage.convert2Currency3(e.Item.DataItem("sumOvertime") - da.Rows(0)("sumOvertime")).ToString + "</div></TD><TD align='right'><div style='width:65px;'>" + ClsManage.convert2PercenNoneZero(e.Item.DataItem("sumOvertime") - da.Rows(0)("sumOvertime"), e.Item.DataItem("sumTotalRevenue") - da.Rows(0)("sumTotalRevenue")).ToString + "%</div></TD></TR>" + _
"<TR id='e5c" + TbCk.Text + "'><TD align='right'><div style='width:110px'>" + ClsManage.convert2Currency3(da.Rows(0)("sumLicensefee")).ToString + "</div></TD><TD align='right'><div style='width:65px;'>" + ClsManage.convert2Currency4((da.Rows(0)("sumLicensefee") / da.Rows(0)("sumTotalRevenue")) * 100).ToString + "%</div></TD><TD align='right'><div style='width:110px'>" + ClsManage.convert2Currency3(e.Item.DataItem("sumLicensefee") - da.Rows(0)("sumLicensefee")).ToString + "</div></TD><TD align='right'><div style='width:65px;'>" + ClsManage.convert2PercenNoneZero(e.Item.DataItem("sumLicensefee") - da.Rows(0)("sumLicensefee"), e.Item.DataItem("sumTotalRevenue") - da.Rows(0)("sumTotalRevenue")).ToString + "%</div></TD></TR>" + _
"<TR id='e6c" + TbCk.Text + "'><TD align='right'><div style='width:110px'>" + ClsManage.convert2Currency3(da.Rows(0)("sumBonuses_Incentives")).ToString + "</div></TD><TD align='right'><div style='width:65px;'>" + ClsManage.convert2Currency4((da.Rows(0)("sumBonuses_Incentives") / da.Rows(0)("sumTotalRevenue")) * 100).ToString + "%</div></TD><TD align='right'><div style='width:110px'>" + ClsManage.convert2Currency3(e.Item.DataItem("sumBonuses_Incentives") - da.Rows(0)("sumBonuses_Incentives")).ToString + "</div></TD><TD align='right'><div style='width:65px;'>" + ClsManage.convert2PercenNoneZero(e.Item.DataItem("sumBonuses_Incentives") - da.Rows(0)("sumBonuses_Incentives"), e.Item.DataItem("sumTotalRevenue") - da.Rows(0)("sumTotalRevenue")).ToString + "%</div></TD></TR>" + _
"<TR id='e7c" + TbCk.Text + "'><TD align='right'><div style='width:110px'>" + ClsManage.convert2Currency3(da.Rows(0)("sumBootsBrandncentives")).ToString + "</div></TD><TD align='right'><div style='width:65px;'>" + ClsManage.convert2Currency4((da.Rows(0)("sumBootsBrandncentives") / da.Rows(0)("sumTotalRevenue")) * 100).ToString + "%</div></TD><TD align='right'><div style='width:110px'>" + ClsManage.convert2Currency3(e.Item.DataItem("sumBootsBrandncentives") - da.Rows(0)("sumBootsBrandncentives")).ToString + "</div></TD><TD align='right'><div style='width:65px;'>" + ClsManage.convert2PercenNoneZero(e.Item.DataItem("sumBootsBrandncentives") - da.Rows(0)("sumBootsBrandncentives"), e.Item.DataItem("sumTotalRevenue") - da.Rows(0)("sumTotalRevenue")).ToString + "%</div></TD></TR>" + _
"<TR id='e8c" + TbCk.Text + "'><TD align='right'><div style='width:110px'>" + ClsManage.convert2Currency3(da.Rows(0)("sumSuppliersIncentive")).ToString + "</div></TD><TD align='right'><div style='width:65px;'>" + ClsManage.convert2Currency4((da.Rows(0)("sumSuppliersIncentive") / da.Rows(0)("sumTotalRevenue")) * 100).ToString + "%</div></TD><TD align='right'><div style='width:110px'>" + ClsManage.convert2Currency3(e.Item.DataItem("sumSuppliersIncentive") - da.Rows(0)("sumSuppliersIncentive")).ToString + "</div></TD><TD align='right'><div style='width:65px;'>" + ClsManage.convert2PercenNoneZero(e.Item.DataItem("sumSuppliersIncentive") - da.Rows(0)("sumSuppliersIncentive"), e.Item.DataItem("sumTotalRevenue") - da.Rows(0)("sumTotalRevenue")).ToString + "%</div></TD></TR>" + _
"<TR id='e9c" + TbCk.Text + "'><TD align='right'><div style='width:110px'>" + ClsManage.convert2Currency3(da.Rows(0)("sumProvidentFund")).ToString + "</div></TD><TD align='right'><div style='width:65px;'>" + ClsManage.convert2Currency4((da.Rows(0)("sumProvidentFund") / da.Rows(0)("sumTotalRevenue")) * 100).ToString + "%</div></TD><TD align='right'><div style='width:110px'>" + ClsManage.convert2Currency3(e.Item.DataItem("sumProvidentFund") - da.Rows(0)("sumProvidentFund")).ToString + "</div></TD><TD align='right'><div style='width:65px;'>" + ClsManage.convert2PercenNoneZero(e.Item.DataItem("sumProvidentFund") - da.Rows(0)("sumProvidentFund"), e.Item.DataItem("sumTotalRevenue") - da.Rows(0)("sumTotalRevenue")).ToString + "%</div></TD></TR>" + _
"<TR id='e10c" + TbCk.Text + "'><TD align='right'><div style='width:110px'>" + ClsManage.convert2Currency3(da.Rows(0)("sumPensionCosts")).ToString + "</div></TD><TD align='right'><div style='width:65px;'>" + ClsManage.convert2Currency4((da.Rows(0)("sumPensionCosts") / da.Rows(0)("sumTotalRevenue")) * 100).ToString + "%</div></TD><TD align='right'><div style='width:110px'>" + ClsManage.convert2Currency3(e.Item.DataItem("sumPensionCosts") - da.Rows(0)("sumPensionCosts")).ToString + "</div></TD><TD align='right'><div style='width:65px;'>" + ClsManage.convert2PercenNoneZero(e.Item.DataItem("sumPensionCosts") - da.Rows(0)("sumPensionCosts"), e.Item.DataItem("sumTotalRevenue") - da.Rows(0)("sumTotalRevenue")).ToString + "%</div></TD></TR>" + _
"<TR id='e11c" + TbCk.Text + "'><TD align='right'><div style='width:110px'>" + ClsManage.convert2Currency3(da.Rows(0)("sumSocialSecurityFund")).ToString + "</div></TD><TD align='right'><div style='width:65px;'>" + ClsManage.convert2Currency4((da.Rows(0)("sumSocialSecurityFund") / da.Rows(0)("sumTotalRevenue")) * 100).ToString + "%</div></TD><TD align='right'><div style='width:110px'>" + ClsManage.convert2Currency3(e.Item.DataItem("sumSocialSecurityFund") - da.Rows(0)("sumSocialSecurityFund")).ToString + "</div></TD><TD align='right'><div style='width:65px;'>" + ClsManage.convert2PercenNoneZero(e.Item.DataItem("sumSocialSecurityFund") - da.Rows(0)("sumSocialSecurityFund"), e.Item.DataItem("sumTotalRevenue") - da.Rows(0)("sumTotalRevenue")).ToString + "%</div></TD></TR>" + _
"<TR id='e12c" + TbCk.Text + "'><TD align='right'><div style='width:110px'>" + ClsManage.convert2Currency3(da.Rows(0)("sumUniforms")).ToString + "</div></TD><TD align='right'><div style='width:65px;'>" + ClsManage.convert2Currency4((da.Rows(0)("sumUniforms") / da.Rows(0)("sumTotalRevenue")) * 100).ToString + "%</div></TD><TD align='right'><div style='width:110px'>" + ClsManage.convert2Currency3(e.Item.DataItem("sumUniforms") - da.Rows(0)("sumUniforms")).ToString + "</div></TD><TD align='right'><div style='width:65px;'>" + ClsManage.convert2PercenNoneZero(e.Item.DataItem("sumUniforms") - da.Rows(0)("sumUniforms"), e.Item.DataItem("sumTotalRevenue") - da.Rows(0)("sumTotalRevenue")).ToString + "%</div></TD></TR>" + _
"<TR id='e13c" + TbCk.Text + "'><TD align='right'><div style='width:110px'>" + ClsManage.convert2Currency3(da.Rows(0)("sumEmployeeWelfare")).ToString + "</div></TD><TD align='right'><div style='width:65px;'>" + ClsManage.convert2Currency4((da.Rows(0)("sumEmployeeWelfare") / da.Rows(0)("sumTotalRevenue")) * 100).ToString + "%</div></TD><TD align='right'><div style='width:110px'>" + ClsManage.convert2Currency3(e.Item.DataItem("sumEmployeeWelfare") - da.Rows(0)("sumEmployeeWelfare")).ToString + "</div></TD><TD align='right'><div style='width:65px;'>" + ClsManage.convert2PercenNoneZero(e.Item.DataItem("sumEmployeeWelfare") - da.Rows(0)("sumEmployeeWelfare"), e.Item.DataItem("sumTotalRevenue") - da.Rows(0)("sumTotalRevenue")).ToString + "%</div></TD></TR>" + _
"<TR id='e14c" + TbCk.Text + "'><TD align='right'><div style='width:110px'>" + ClsManage.convert2Currency3(da.Rows(0)("sumOtherBenefitsEmployee")).ToString + "</div></TD><TD align='right'><div style='width:65px;'>" + ClsManage.convert2Currency4((da.Rows(0)("sumOtherBenefitsEmployee") / da.Rows(0)("sumTotalRevenue")) * 100).ToString + "%</div></TD><TD align='right'><div style='width:110px'>" + ClsManage.convert2Currency3(e.Item.DataItem("sumOtherBenefitsEmployee") - da.Rows(0)("sumOtherBenefitsEmployee")).ToString + "</div></TD><TD align='right'><div style='width:65px;'>" + ClsManage.convert2PercenNoneZero(e.Item.DataItem("sumOtherBenefitsEmployee") - da.Rows(0)("sumOtherBenefitsEmployee"), e.Item.DataItem("sumTotalRevenue") - da.Rows(0)("sumTotalRevenue")).ToString + "%</div></TD></TR>" + _
"<TR style='font-weight:bold;'><TD align='right'><div style='width:110px'>" + ClsManage.convert2Currency3(da.Rows(0)("sumStorePropertyCosts")).ToString + "</div></TD><TD align='right'><div style='width:65px;'>" + ClsManage.convert2Currency4((da.Rows(0)("sumStorePropertyCosts") / da.Rows(0)("sumTotalRevenue")) * 100).ToString + "%</div></TD><TD align='right'><div style='width:110px'>" + ClsManage.convert2Currency3(e.Item.DataItem("sumStorePropertyCosts") - da.Rows(0)("sumStorePropertyCosts")).ToString + "</div></TD><TD align='right'><div style='width:65px;'>" + ClsManage.convert2PercenNoneZero(e.Item.DataItem("sumStorePropertyCosts") - da.Rows(0)("sumStorePropertyCosts"), e.Item.DataItem("sumTotalRevenue") - da.Rows(0)("sumTotalRevenue")).ToString + "%</div></TD></TR>" + _
"<TR id='f1c" + TbCk.Text + "'><TD align='right'><div style='width:110px'>" + ClsManage.convert2Currency3(da.Rows(0)("sumPropertyRental")).ToString + "</div></TD><TD align='right'><div style='width:65px;'>" + ClsManage.convert2Currency4((da.Rows(0)("sumPropertyRental") / da.Rows(0)("sumTotalRevenue")) * 100).ToString + "%</div></TD><TD align='right'><div style='width:110px'>" + ClsManage.convert2Currency3(e.Item.DataItem("sumPropertyRental") - da.Rows(0)("sumPropertyRental")).ToString + "</div></TD><TD align='right'><div style='width:65px;'>" + ClsManage.convert2PercenNoneZero(e.Item.DataItem("sumPropertyRental") - da.Rows(0)("sumPropertyRental"), e.Item.DataItem("sumTotalRevenue") - da.Rows(0)("sumTotalRevenue")).ToString + "%</div></TD></TR>" + _
"<TR id='f2c" + TbCk.Text + "'><TD align='right'><div style='width:110px'>" + ClsManage.convert2Currency3(da.Rows(0)("sumPropertyServices")).ToString + "</div></TD><TD align='right'><div style='width:65px;'>" + ClsManage.convert2Currency4((da.Rows(0)("sumPropertyServices") / da.Rows(0)("sumTotalRevenue")) * 100).ToString + "%</div></TD><TD align='right'><div style='width:110px'>" + ClsManage.convert2Currency3(e.Item.DataItem("sumPropertyServices") - da.Rows(0)("sumPropertyServices")).ToString + "</div></TD><TD align='right'><div style='width:65px;'>" + ClsManage.convert2PercenNoneZero(e.Item.DataItem("sumPropertyServices") - da.Rows(0)("sumPropertyServices"), e.Item.DataItem("sumTotalRevenue") - da.Rows(0)("sumTotalRevenue")).ToString + "%</div></TD></TR>" + _
"<TR id='f3c" + TbCk.Text + "'><TD align='right'><div style='width:110px'>" + ClsManage.convert2Currency3(da.Rows(0)("sumPropertyFacility")).ToString + "</div></TD><TD align='right'><div style='width:65px;'>" + ClsManage.convert2Currency4((da.Rows(0)("sumPropertyFacility") / da.Rows(0)("sumTotalRevenue")) * 100).ToString + "%</div></TD><TD align='right'><div style='width:110px'>" + ClsManage.convert2Currency3(e.Item.DataItem("sumPropertyFacility") - da.Rows(0)("sumPropertyFacility")).ToString + "</div></TD><TD align='right'><div style='width:65px;'>" + ClsManage.convert2PercenNoneZero(e.Item.DataItem("sumPropertyFacility") - da.Rows(0)("sumPropertyFacility"), e.Item.DataItem("sumTotalRevenue") - da.Rows(0)("sumTotalRevenue")).ToString + "%</div></TD></TR>" + _
"<TR id='f4c" + TbCk.Text + "'><TD align='right'><div style='width:110px'>" + ClsManage.convert2Currency3(da.Rows(0)("sumPropertytaxes")).ToString + "</div></TD><TD align='right'><div style='width:65px;'>" + ClsManage.convert2Currency4((da.Rows(0)("sumPropertytaxes") / da.Rows(0)("sumTotalRevenue")) * 100).ToString + "%</div></TD><TD align='right'><div style='width:110px'>" + ClsManage.convert2Currency3(e.Item.DataItem("sumPropertytaxes") - da.Rows(0)("sumPropertytaxes")).ToString + "</div></TD><TD align='right'><div style='width:65px;'>" + ClsManage.convert2PercenNoneZero(e.Item.DataItem("sumPropertytaxes") - da.Rows(0)("sumPropertytaxes"), e.Item.DataItem("sumTotalRevenue") - da.Rows(0)("sumTotalRevenue")).ToString + "%</div></TD></TR>" + _
"<TR id='f5c" + TbCk.Text + "'><TD align='right'><div style='width:110px'>" + ClsManage.convert2Currency3(da.Rows(0)("sumFacialtaxes")).ToString + "</div></TD><TD align='right'><div style='width:65px;'>" + ClsManage.convert2Currency4((da.Rows(0)("sumFacialtaxes") / da.Rows(0)("sumTotalRevenue")) * 100).ToString + "%</div></TD><TD align='right'><div style='width:110px'>" + ClsManage.convert2Currency3(e.Item.DataItem("sumFacialtaxes") - da.Rows(0)("sumFacialtaxes")).ToString + "</div></TD><TD align='right'><div style='width:65px;'>" + ClsManage.convert2PercenNoneZero(e.Item.DataItem("sumFacialtaxes") - da.Rows(0)("sumFacialtaxes"), e.Item.DataItem("sumTotalRevenue") - da.Rows(0)("sumTotalRevenue")).ToString + "%</div></TD></TR>" + _
"<TR id='f6c" + TbCk.Text + "'><TD align='right'><div style='width:110px'>" + ClsManage.convert2Currency3(da.Rows(0)("sumPropertyInsurance")).ToString + "</div></TD><TD align='right'><div style='width:65px;'>" + ClsManage.convert2Currency4((da.Rows(0)("sumPropertyInsurance") / da.Rows(0)("sumTotalRevenue")) * 100).ToString + "%</div></TD><TD align='right'><div style='width:110px'>" + ClsManage.convert2Currency3(e.Item.DataItem("sumPropertyInsurance") - da.Rows(0)("sumPropertyInsurance")).ToString + "</div></TD><TD align='right'><div style='width:65px;'>" + ClsManage.convert2PercenNoneZero(e.Item.DataItem("sumPropertyInsurance") - da.Rows(0)("sumPropertyInsurance"), e.Item.DataItem("sumTotalRevenue") - da.Rows(0)("sumTotalRevenue")).ToString + "%</div></TD></TR>" + _
"<TR id='f7c" + TbCk.Text + "'><TD align='right'><div style='width:110px'>" + ClsManage.convert2Currency3(da.Rows(0)("sumSignboard")).ToString + "</div></TD><TD align='right'><div style='width:65px;'>" + ClsManage.convert2Currency4((da.Rows(0)("sumSignboard") / da.Rows(0)("sumTotalRevenue")) * 100).ToString + "%</div></TD><TD align='right'><div style='width:110px'>" + ClsManage.convert2Currency3(e.Item.DataItem("sumSignboard") - da.Rows(0)("sumSignboard")).ToString + "</div></TD><TD align='right'><div style='width:65px;'>" + ClsManage.convert2PercenNoneZero(e.Item.DataItem("sumSignboard") - da.Rows(0)("sumSignboard"), e.Item.DataItem("sumTotalRevenue") - da.Rows(0)("sumTotalRevenue")).ToString + "%</div></TD></TR>" + _
"<TR id='f8c" + TbCk.Text + "'><TD align='right'><div style='width:110px'>" + ClsManage.convert2Currency3(da.Rows(0)("sumDiscount_Rent_Services_Facility")).ToString + "</div></TD><TD align='right'><div style='width:65px;'>" + ClsManage.convert2Currency4((da.Rows(0)("sumDiscount_Rent_Services_Facility") / da.Rows(0)("sumTotalRevenue")) * 100).ToString + "%</div></TD><TD align='right'><div style='width:110px'>" + ClsManage.convert2Currency3(e.Item.DataItem("sumDiscount_Rent_Services_Facility") - da.Rows(0)("sumDiscount_Rent_Services_Facility")).ToString + "</div></TD><TD align='right'><div style='width:65px;'>" + ClsManage.convert2PercenNoneZero(e.Item.DataItem("sumDiscount_Rent_Services_Facility") - da.Rows(0)("sumDiscount_Rent_Services_Facility"), e.Item.DataItem("sumTotalRevenue") - da.Rows(0)("sumTotalRevenue")).ToString + "%</div></TD></TR>" + _
"<TR id='f9c" + TbCk.Text + "'><TD align='right'><div style='width:110px'>" + ClsManage.convert2Currency3(da.Rows(0)("sumGPCommission")).ToString + "</div></TD><TD align='right'><div style='width:65px;'>" + ClsManage.convert2Currency4((da.Rows(0)("sumGPCommission") / da.Rows(0)("sumTotalRevenue")) * 100).ToString + "%</div></TD><TD align='right'><div style='width:110px'>" + ClsManage.convert2Currency3(e.Item.DataItem("sumGPCommission") - da.Rows(0)("sumGPCommission")).ToString + "</div></TD><TD align='right'><div style='width:65px;'>" + ClsManage.convert2PercenNoneZero(e.Item.DataItem("sumGPCommission") - da.Rows(0)("sumGPCommission"), e.Item.DataItem("sumTotalRevenue") - da.Rows(0)("sumTotalRevenue")).ToString + "%</div></TD></TR>" + _
"<TR id='f10c" + TbCk.Text + "'><TD align='right'><div style='width:110px'>" + ClsManage.convert2Currency3(da.Rows(0)("sumAmortizationofLeaseRight")).ToString + "</div></TD><TD align='right'><div style='width:65px;'>" + ClsManage.convert2Currency4((da.Rows(0)("sumAmortizationofLeaseRight") / da.Rows(0)("sumTotalRevenue")) * 100).ToString + "%</div></TD><TD align='right'><div style='width:110px'>" + ClsManage.convert2Currency3(e.Item.DataItem("sumAmortizationofLeaseRight") - da.Rows(0)("sumAmortizationofLeaseRight")).ToString + "</div></TD><TD align='right'><div style='width:65px;'>" + ClsManage.convert2PercenNoneZero(e.Item.DataItem("sumAmortizationofLeaseRight") - da.Rows(0)("sumAmortizationofLeaseRight"), e.Item.DataItem("sumTotalRevenue") - da.Rows(0)("sumTotalRevenue")).ToString + "%</div></TD></TR>" + _
"<TR style='font-weight:bold;'><TD align='right'><div style='width:110px'>" + ClsManage.convert2Currency3(da.Rows(0)("sumDepreciation")).ToString + "</div></TD><TD align='right'><div style='width:65px;'>" + ClsManage.convert2Currency4((da.Rows(0)("sumDepreciation") / da.Rows(0)("sumTotalRevenue")) * 100).ToString + "%</div></TD><TD align='right'><div style='width:110px'>" + ClsManage.convert2Currency3(e.Item.DataItem("sumDepreciation") - da.Rows(0)("sumDepreciation")).ToString + "</div></TD><TD align='right'><div style='width:65px;'>" + ClsManage.convert2PercenNoneZero(e.Item.DataItem("sumDepreciation") - da.Rows(0)("sumDepreciation"), e.Item.DataItem("sumTotalRevenue") - da.Rows(0)("sumTotalRevenue")).ToString + "%</div></TD></TR>" + _
"<TR id='g1c" + TbCk.Text + "'><TD align='right'><div style='width:110px'>" + ClsManage.convert2Currency3(da.Rows(0)("sumDepreciationofShortLeaseBuilding")).ToString + "</div></TD><TD align='right'><div style='width:65px;'>" + ClsManage.convert2Currency4((da.Rows(0)("sumDepreciationofShortLeaseBuilding") / da.Rows(0)("sumTotalRevenue")) * 100).ToString + "%</div></TD><TD align='right'><div style='width:110px'>" + ClsManage.convert2Currency3(e.Item.DataItem("sumDepreciationofShortLeaseBuilding") - da.Rows(0)("sumDepreciationofShortLeaseBuilding")).ToString + "</div></TD><TD align='right'><div style='width:65px;'>" + ClsManage.convert2PercenNoneZero(e.Item.DataItem("sumDepreciationofShortLeaseBuilding") - da.Rows(0)("sumDepreciationofShortLeaseBuilding"), e.Item.DataItem("sumTotalRevenue") - da.Rows(0)("sumTotalRevenue")).ToString + "%</div></TD></TR>" + _
"<TR id='g2c" + TbCk.Text + "'><TD align='right'><div style='width:110px'>" + ClsManage.convert2Currency3(da.Rows(0)("sumDepreciationofComputerHardware")).ToString + "</div></TD><TD align='right'><div style='width:65px;'>" + ClsManage.convert2Currency4((da.Rows(0)("sumDepreciationofComputerHardware") / da.Rows(0)("sumTotalRevenue")) * 100).ToString + "%</div></TD><TD align='right'><div style='width:110px'>" + ClsManage.convert2Currency3(e.Item.DataItem("sumDepreciationofComputerHardware") - da.Rows(0)("sumDepreciationofComputerHardware")).ToString + "</div></TD><TD align='right'><div style='width:65px;'>" + ClsManage.convert2PercenNoneZero(e.Item.DataItem("sumDepreciationofComputerHardware") - da.Rows(0)("sumDepreciationofComputerHardware"), e.Item.DataItem("sumTotalRevenue") - da.Rows(0)("sumTotalRevenue")).ToString + "%</div></TD></TR>" + _
"<TR id='g3c" + TbCk.Text + "'><TD align='right'><div style='width:110px'>" + ClsManage.convert2Currency3(da.Rows(0)("sumDepreciationofFixturesFittings")).ToString + "</div></TD><TD align='right'><div style='width:65px;'>" + ClsManage.convert2Currency4((da.Rows(0)("sumDepreciationofFixturesFittings") / da.Rows(0)("sumTotalRevenue")) * 100).ToString + "%</div></TD><TD align='right'><div style='width:110px'>" + ClsManage.convert2Currency3(e.Item.DataItem("sumDepreciationofFixturesFittings") - da.Rows(0)("sumDepreciationofFixturesFittings")).ToString + "</div></TD><TD align='right'><div style='width:65px;'>" + ClsManage.convert2PercenNoneZero(e.Item.DataItem("sumDepreciationofFixturesFittings") - da.Rows(0)("sumDepreciationofFixturesFittings"), e.Item.DataItem("sumTotalRevenue") - da.Rows(0)("sumTotalRevenue")).ToString + "%</div></TD></TR>" + _
"<TR id='g4c" + TbCk.Text + "'><TD align='right'><div style='width:110px'>" + ClsManage.convert2Currency3(da.Rows(0)("sumDepreciationofComputerSoftware")).ToString + "</div></TD><TD align='right'><div style='width:65px;'>" + ClsManage.convert2Currency4((da.Rows(0)("sumDepreciationofComputerSoftware") / da.Rows(0)("sumTotalRevenue")) * 100).ToString + "%</div></TD><TD align='right'><div style='width:110px'>" + ClsManage.convert2Currency3(e.Item.DataItem("sumDepreciationofComputerSoftware") - da.Rows(0)("sumDepreciationofComputerSoftware")).ToString + "</div></TD><TD align='right'><div style='width:65px;'>" + ClsManage.convert2PercenNoneZero(e.Item.DataItem("sumDepreciationofComputerSoftware") - da.Rows(0)("sumDepreciationofComputerSoftware"), e.Item.DataItem("sumTotalRevenue") - da.Rows(0)("sumTotalRevenue")).ToString + "%</div></TD></TR>" + _
"<TR id='g5c" + TbCk.Text + "'><TD align='right'><div style='width:110px'>" + ClsManage.convert2Currency3(da.Rows(0)("sumDepreciationofOfficeEquipment")).ToString + "</div></TD><TD align='right'><div style='width:65px;'>" + ClsManage.convert2Currency4((da.Rows(0)("sumDepreciationofOfficeEquipment") / da.Rows(0)("sumTotalRevenue")) * 100).ToString + "%</div></TD><TD align='right'><div style='width:110px'>" + ClsManage.convert2Currency3(e.Item.DataItem("sumDepreciationofOfficeEquipment") - da.Rows(0)("sumDepreciationofOfficeEquipment")).ToString + "</div></TD><TD align='right'><div style='width:65px;'>" + ClsManage.convert2PercenNoneZero(e.Item.DataItem("sumDepreciationofOfficeEquipment") - da.Rows(0)("sumDepreciationofOfficeEquipment"), e.Item.DataItem("sumTotalRevenue") - da.Rows(0)("sumTotalRevenue")).ToString + "%</div></TD></TR>" + _
"<TR style='font-weight:bold;'><TD align='right'><div style='width:110px'>" + ClsManage.convert2Currency3(da.Rows(0)("sumOtherStoreCosts")).ToString + "</div></TD><TD align='right'><div style='width:65px;'>" + ClsManage.convert2Currency4((da.Rows(0)("sumOtherStoreCosts") / da.Rows(0)("sumTotalRevenue")) * 100).ToString + "%</div></TD><TD align='right'><div style='width:110px'>" + ClsManage.convert2Currency3(e.Item.DataItem("sumOtherStoreCosts") - da.Rows(0)("sumOtherStoreCosts")).ToString + "</div></TD><TD align='right'><div style='width:65px;'>" + ClsManage.convert2PercenNoneZero(e.Item.DataItem("sumOtherStoreCosts") - da.Rows(0)("sumOtherStoreCosts"), e.Item.DataItem("sumTotalRevenue") - da.Rows(0)("sumTotalRevenue")).ToString + "%</div></TD></TR>" + _
"<TR id='h1c" + TbCk.Text + "'><TD align='right'><div style='width:110px'>" + ClsManage.convert2Currency3(da.Rows(0)("sumServiceChargesandOtherFees")).ToString + "</div></TD><TD align='right'><div style='width:65px;'>" + ClsManage.convert2Currency4((da.Rows(0)("sumServiceChargesandOtherFees") / da.Rows(0)("sumTotalRevenue")) * 100).ToString + "%</div></TD><TD align='right'><div style='width:110px'>" + ClsManage.convert2Currency3(e.Item.DataItem("sumServiceChargesandOtherFees") - da.Rows(0)("sumServiceChargesandOtherFees")).ToString + "</div></TD><TD align='right'><div style='width:65px;'>" + ClsManage.convert2PercenNoneZero(e.Item.DataItem("sumServiceChargesandOtherFees") - da.Rows(0)("sumServiceChargesandOtherFees"), e.Item.DataItem("sumTotalRevenue") - da.Rows(0)("sumTotalRevenue")).ToString + "%</div></TD></TR>" + _
"<TR id='h2c" + TbCk.Text + "'><TD align='right'><div style='width:110px'>" + ClsManage.convert2Currency3(da.Rows(0)("sumBankCharges")).ToString + "</div></TD><TD align='right'><div style='width:65px;'>" + ClsManage.convert2Currency4((da.Rows(0)("sumBankCharges") / da.Rows(0)("sumTotalRevenue")) * 100).ToString + "%</div></TD><TD align='right'><div style='width:110px'>" + ClsManage.convert2Currency3(e.Item.DataItem("sumBankCharges") - da.Rows(0)("sumBankCharges")).ToString + "</div></TD><TD align='right'><div style='width:65px;'>" + ClsManage.convert2PercenNoneZero(e.Item.DataItem("sumBankCharges") - da.Rows(0)("sumBankCharges"), e.Item.DataItem("sumTotalRevenue") - da.Rows(0)("sumTotalRevenue")).ToString + "%</div></TD></TR>" + _
...
"<TR id='h4c" + TbCk.Text + "'><TD align='right'><div style='width:110px'>" + ClsManage.convert2Currency3(da.Rows(0)("sumCleaning")).ToString + "</div></TD><TD align='right'><div style='width:65px;'>" + ClsManage.convert2Currency4((da.Rows(0)("sumCleaning") / da.Rows(0)("sumTotalRevenue")) * 100).ToString + "%</div></TD><TD align='right'><div style='width:110px'>" + ClsManage.convert2Currency3(e.Item.DataItem("sumCleaning") - da.Rows(0)("sumCleaning")).ToString + "</div></TD><TD align='right'><div style='width:65px;'>" + ClsManage.convert2PercenNoneZero(e.Item.DataItem("sumCleaning") - da.Rows(0)("sumCleaning"), e.Item.DataItem("sumTotalRevenue") - da.Rows(0)("sumTotalRevenue")).ToString + "%</div></TD></TR>" + _
"<TR id='h5c" + TbCk.Text + "'><TD align='right'><div style='width:110px'>" + ClsManage.convert2Currency3(da.Rows(0)("sumSecurityGuards")).ToString + "</div></TD><TD align='right'><div style='width:65px;'>" + ClsManage.convert2Currency4((da.Rows(0)("sumSecurityGuards") / da.Rows(0)("sumTotalRevenue")) * 100).ToString + "%</div></TD><TD align='right'><div style='width:110px'>" + ClsManage.convert2Currency3(e.Item.DataItem("sumSecurityGuards") - da.Rows(0)("sumSecurityGuards")).ToString + "</div></TD><TD align='right'><div style='width:65px;'>" + ClsManage.convert2PercenNoneZero(e.Item.DataItem("sumSecurityGuards") - da.Rows(0)("sumSecurityGuards"), e.Item.DataItem("sumTotalRevenue") - da.Rows(0)("sumTotalRevenue")).ToString + "%</div></TD></TR>" + _
"<TR id='h6c" + TbCk.Text + "'><TD align='right'><div style='width:110px'>" + ClsManage.convert2Currency3(da.Rows(0)("sumCarriage")).ToString + "</div></TD><TD align='right'><div style='width:65px;'>" + ClsManage.convert2Currency4((da.Rows(0)("sumCarriage") / da.Rows(0)("sumTotalRevenue")) * 100).ToString + "%</div></TD><TD align='right'><div style='width:110px'>" + ClsManage.convert2Currency3(e.Item.DataItem("sumCarriage") - da.Rows(0)("sumCarriage")).ToString + "</div></TD><TD align='right'><div style='width:65px;'>" + ClsManage.convert2PercenNoneZero(e.Item.DataItem("sumCarriage") - da.Rows(0)("sumCarriage"), e.Item.DataItem("sumTotalRevenue") - da.Rows(0)("sumTotalRevenue")).ToString + "%</div></TD></TR>" + _
"<TR id='h7c" + TbCk.Text + "'><TD align='right'><div style='width:110px'>" + ClsManage.convert2Currency3(da.Rows(0)("sumLicenceFees")).ToString + "</div></TD><TD align='right'><div style='width:65px;'>" + ClsManage.convert2Currency4((da.Rows(0)("sumLicenceFees") / da.Rows(0)("sumTotalRevenue")) * 100).ToString + "%</div></TD><TD align='right'><div style='width:110px'>" + ClsManage.convert2Currency3(e.Item.DataItem("sumLicenceFees") - da.Rows(0)("sumLicenceFees")).ToString + "</div></TD><TD align='right'><div style='width:65px;'>" + ClsManage.convert2PercenNoneZero(e.Item.DataItem("sumLicenceFees") - da.Rows(0)("sumLicenceFees"), e.Item.DataItem("sumTotalRevenue") - da.Rows(0)("sumTotalRevenue")).ToString + "%</div></TD></TR>" + _
"<TR id='h8c" + TbCk.Text + "'><TD align='right'><div style='width:110px'>" + ClsManage.convert2Currency3(da.Rows(0)("sumOtherServicesCharge")).ToString + "</div></TD><TD align='right'><div style='width:65px;'>" + ClsManage.convert2Currency4((da.Rows(0)("sumOtherServicesCharge") / da.Rows(0)("sumTotalRevenue")) * 100).ToString + "%</div></TD><TD align='right'><div style='width:110px'>" + ClsManage.convert2Currency3(e.Item.DataItem("sumOtherServicesCharge") - da.Rows(0)("sumOtherServicesCharge")).ToString + "</div></TD><TD align='right'><div style='width:65px;'>" + ClsManage.convert2PercenNoneZero(e.Item.DataItem("sumOtherServicesCharge") - da.Rows(0)("sumOtherServicesCharge"), e.Item.DataItem("sumTotalRevenue") - da.Rows(0)("sumTotalRevenue")).ToString + "%</div></TD></TR>" + _
"<TR id='h9c" + TbCk.Text + "'><TD align='right'><div style='width:110px'>" + ClsManage.convert2Currency3(da.Rows(0)("sumOtherFees")).ToString + "</div></TD><TD align='right'><div style='width:65px;'>" + ClsManage.convert2Currency4((da.Rows(0)("sumOtherFees") / da.Rows(0)("sumTotalRevenue")) * 100).ToString + "%</div></TD><TD align='right'><div style='width:110px'>" + ClsManage.convert2Currency3(e.Item.DataItem("sumOtherFees") - da.Rows(0)("sumOtherFees")).ToString + "</div></TD><TD align='right'><div style='width:65px;'>" + ClsManage.convert2PercenNoneZero(e.Item.DataItem("sumOtherFees") - da.Rows(0)("sumOtherFees"), e.Item.DataItem("sumTotalRevenue") - da.Rows(0)("sumTotalRevenue")).ToString + "%</div></TD></TR>" + _
"<TR id='h10c" + TbCk.Text + "'><TD align='right'><div style='width:110px'>" + ClsManage.convert2Currency3(da.Rows(0)("sumUtilities")).ToString + "</div></TD><TD align='right'><div style='width:65px;'>" + ClsManage.convert2Currency4((da.Rows(0)("sumUtilities") / da.Rows(0)("sumTotalRevenue")) * 100).ToString + "%</div></TD><TD align='right'><div style='width:110px'>" + ClsManage.convert2Currency3(e.Item.DataItem("sumUtilities") - da.Rows(0)("sumUtilities")).ToString + "</div></TD><TD align='right'><div style='width:65px;'>" + ClsManage.convert2PercenNoneZero(e.Item.DataItem("sumUtilities") - da.Rows(0)("sumUtilities"), e.Item.DataItem("sumTotalRevenue") - da.Rows(0)("sumTotalRevenue")).ToString + "%</div></TD></TR>" + _
"<TR id='h11c" + TbCk.Text + "'><TD align='right'><div style='width:110px'>" + ClsManage.convert2Currency3(da.Rows(0)("sumWater")).ToString + "</div></TD><TD align='right'><div style='width:65px;'>" + ClsManage.convert2Currency4((da.Rows(0)("sumWater") / da.Rows(0)("sumTotalRevenue")) * 100).ToString + "%</div></TD><TD align='right'><div style='width:110px'>" + ClsManage.convert2Currency3(e.Item.DataItem("sumWater") - da.Rows(0)("sumWater")).ToString + "</div></TD><TD align='right'><div style='width:65px;'>" + ClsManage.convert2PercenNoneZero(e.Item.DataItem("sumWater") - da.Rows(0)("sumWater"), e.Item.DataItem("sumTotalRevenue") - da.Rows(0)("sumTotalRevenue")).ToString + "%</div></TD></TR>" + _
"<TR id='h12c" + TbCk.Text + "'><TD align='right'><div style='width:110px'>" + ClsManage.convert2Currency3(da.Rows(0)("sumGas_Electric")).ToString + "</div></TD><TD align='right'><div style='width:65px;'>" + ClsManage.convert2Currency4((da.Rows(0)("sumGas_Electric") / da.Rows(0)("sumTotalRevenue")) * 100).ToString + "%</div></TD><TD align='right'><div style='width:110px'>" + ClsManage.convert2Currency3(e.Item.DataItem("sumGas_Electric") - da.Rows(0)("sumGas_Electric")).ToString + "</div></TD><TD align='right'><div style='width:65px;'>" + ClsManage.convert2PercenNoneZero(e.Item.DataItem("sumGas_Electric") - da.Rows(0)("sumGas_Electric"), e.Item.DataItem("sumTotalRevenue") - da.Rows(0)("sumTotalRevenue")).ToString + "%</div></TD></TR>" + _
"<TR id='h13c" + TbCk.Text + "'><TD align='right'><div style='width:110px'>" + ClsManage.convert2Currency3(da.Rows(0)("sumAirCond_Addition")).ToString + "</div></TD><TD align='right'><div style='width:65px;'>" + ClsManage.convert2Currency4((da.Rows(0)("sumAirCond_Addition") / da.Rows(0)("sumTotalRevenue")) * 100).ToString + "%</div></TD><TD align='right'><div style='width:110px'>" + ClsManage.convert2Currency3(e.Item.DataItem("sumAirCond_Addition") - da.Rows(0)("sumAirCond_Addition")).ToString + "</div></TD><TD align='right'><div style='width:65px;'>" + ClsManage.convert2PercenNoneZero(e.Item.DataItem("sumAirCond_Addition") - da.Rows(0)("sumAirCond_Addition"), e.Item.DataItem("sumTotalRevenue") - da.Rows(0)("sumTotalRevenue")).ToString + "%</div></TD></TR>" + _
"<TR id='h14c" + TbCk.Text + "'><TD align='right'><div style='width:110px'>" + ClsManage.convert2Currency3(da.Rows(0)("sumRepairandMaintenance")).ToString + "</div></TD><TD align='right'><div style='width:65px;'>" + ClsManage.convert2Currency4((da.Rows(0)("sumRepairandMaintenance") / da.Rows(0)("sumTotalRevenue")) * 100).ToString + "%</div></TD><TD align='right'><div style='width:110px'>" + ClsManage.convert2Currency3(e.Item.DataItem("sumRepairandMaintenance") - da.Rows(0)("sumRepairandMaintenance")).ToString + "</div></TD><TD align='right'><div style='width:65px;'>" + ClsManage.convert2PercenNoneZero(e.Item.DataItem("sumRepairandMaintenance") - da.Rows(0)("sumRepairandMaintenance"), e.Item.DataItem("sumTotalRevenue") - da.Rows(0)("sumTotalRevenue")).ToString + "%</div></TD></TR>" + _
"<TR id='h15c" + TbCk.Text + "'><TD align='right'><div style='width:110px'>" + ClsManage.convert2Currency3(da.Rows(0)("sumRMOther_Fix")).ToString + "</div></TD><TD align='right'><div style='width:65px;'>" + ClsManage.convert2Currency4((da.Rows(0)("sumRMOther_Fix") / da.Rows(0)("sumTotalRevenue")) * 100).ToString + "%</div></TD><TD align='right'><div style='width:110px'>" + ClsManage.convert2Currency3(e.Item.DataItem("sumRMOther_Fix") - da.Rows(0)("sumRMOther_Fix")).ToString + "</div></TD><TD align='right'><div style='width:65px;'>" + ClsManage.convert2PercenNoneZero(e.Item.DataItem("sumRMOther_Fix") - da.Rows(0)("sumRMOther_Fix"), e.Item.DataItem("sumTotalRevenue") - da.Rows(0)("sumTotalRevenue")).ToString + "%</div></TD></TR>" + _
"<TR id='h16c" + TbCk.Text + "'><TD align='right'><div style='width:110px'>" + ClsManage.convert2Currency3(da.Rows(0)("sumRMOther_Unplan")).ToString + "</div></TD><TD align='right'><div style='width:65px;'>" + ClsManage.convert2Currency4((da.Rows(0)("sumRMOther_Unplan") / da.Rows(0)("sumTotalRevenue")) * 100).ToString + "%</div></TD><TD align='right'><div style='width:110px'>" + ClsManage.convert2Currency3(e.Item.DataItem("sumRMOther_Unplan") - da.Rows(0)("sumRMOther_Unplan")).ToString + "</div></TD><TD align='right'><div style='width:65px;'>" + ClsManage.convert2PercenNoneZero(e.Item.DataItem("sumRMOther_Unplan") - da.Rows(0)("sumRMOther_Unplan"), e.Item.DataItem("sumTotalRevenue") - da.Rows(0)("sumTotalRevenue")).ToString + "%</div></TD></TR>" + _
"<TR id='h17c" + TbCk.Text + "'><TD align='right'><div style='width:110px'>" + ClsManage.convert2Currency3(da.Rows(0)("sumRMComputer_Fix")).ToString + "</div></TD><TD align='right'><div style='width:65px;'>" + ClsManage.convert2Currency4((da.Rows(0)("sumRMComputer_Fix") / da.Rows(0)("sumTotalRevenue")) * 100).ToString + "%</div></TD><TD align='right'><div style='width:110px'>" + ClsManage.convert2Currency3(e.Item.DataItem("sumRMComputer_Fix") - da.Rows(0)("sumRMComputer_Fix")).ToString + "</div></TD><TD align='right'><div style='width:65px;'>" + ClsManage.convert2PercenNoneZero(e.Item.DataItem("sumRMComputer_Fix") - da.Rows(0)("sumRMComputer_Fix"), e.Item.DataItem("sumTotalRevenue") - da.Rows(0)("sumTotalRevenue")).ToString + "%</div></TD></TR>" + _
"<TR id='h18c" + TbCk.Text + "'><TD align='right'><div style='width:110px'>" + ClsManage.convert2Currency3(da.Rows(0)("sumRMComputer_Unplan")).ToString + "</div></TD><TD align='right'><div style='width:65px;'>" + ClsManage.convert2Currency4((da.Rows(0)("sumRMComputer_Unplan") / da.Rows(0)("sumTotalRevenue")) * 100).ToString + "%</div></TD><TD align='right'><div style='width:110px'>" + ClsManage.convert2Currency3(e.Item.DataItem("sumRMComputer_Unplan") - da.Rows(0)("sumRMComputer_Unplan")).ToString + "</div></TD><TD align='right'><div style='width:65px;'>" + ClsManage.convert2PercenNoneZero(e.Item.DataItem("sumRMComputer_Unplan") - da.Rows(0)("sumRMComputer_Unplan"), e.Item.DataItem("sumTotalRevenue") - da.Rows(0)("sumTotalRevenue")).ToString + "%</div></TD></TR>" + _
"<TR id='h19c" + TbCk.Text + "'><TD align='right'><div style='width:110px'>" + ClsManage.convert2Currency3(da.Rows(0)("sumProfessionalFee")).ToString + "</div></TD><TD align='right'><div style='width:65px;'>" + ClsManage.convert2Currency4((da.Rows(0)("sumProfessionalFee") / da.Rows(0)("sumTotalRevenue")) * 100).ToString + "%</div></TD><TD align='right'><div style='width:110px'>" + ClsManage.convert2Currency3(e.Item.DataItem("sumProfessionalFee") - da.Rows(0)("sumProfessionalFee")).ToString + "</div></TD><TD align='right'><div style='width:65px;'>" + ClsManage.convert2PercenNoneZero(e.Item.DataItem("sumProfessionalFee") - da.Rows(0)("sumProfessionalFee"), e.Item.DataItem("sumTotalRevenue") - da.Rows(0)("sumTotalRevenue")).ToString + "%</div></TD></TR>" + _
"<TR id='h20c" + TbCk.Text + "'><TD align='right'><div style='width:110px'>" + ClsManage.convert2Currency3(da.Rows(0)("sumMarketingResearch")).ToString + "</div></TD><TD align='right'><div style='width:65px;'>" + ClsManage.convert2Currency4((da.Rows(0)("sumMarketingResearch") / da.Rows(0)("sumTotalRevenue")) * 100).ToString + "%</div></TD><TD align='right'><div style='width:110px'>" + ClsManage.convert2Currency3(e.Item.DataItem("sumMarketingResearch") - da.Rows(0)("sumMarketingResearch")).ToString + "</div></TD><TD align='right'><div style='width:65px;'>" + ClsManage.convert2PercenNoneZero(e.Item.DataItem("sumMarketingResearch") - da.Rows(0)("sumMarketingResearch"), e.Item.DataItem("sumTotalRevenue") - da.Rows(0)("sumTotalRevenue")).ToString + "%</div></TD></TR>" + _
"<TR id='h21c" + TbCk.Text + "'><TD align='right'><div style='width:110px'>" + ClsManage.convert2Currency3(da.Rows(0)("sumOtherFee")).ToString + "</div></TD><TD align='right'><div style='width:65px;'>" + ClsManage.convert2Currency4((da.Rows(0)("sumOtherFee") / da.Rows(0)("sumTotalRevenue")) * 100).ToString + "%</div></TD><TD align='right'><div style='width:110px'>" + ClsManage.convert2Currency3(e.Item.DataItem("sumOtherFee") - da.Rows(0)("sumOtherFee")).ToString + "</div></TD><TD align='right'><div style='width:65px;'>" + ClsManage.convert2PercenNoneZero(e.Item.DataItem("sumOtherFee") - da.Rows(0)("sumOtherFee"), e.Item.DataItem("sumTotalRevenue") - da.Rows(0)("sumTotalRevenue")).ToString + "%</div></TD></TR>" + _
"<TR id='h22c" + TbCk.Text + "'><TD align='right'><div style='width:110px'>" + ClsManage.convert2Currency3(da.Rows(0)("sumEquipment_MaterailandSupplies")).ToString + "</div></TD><TD align='right'><div style='width:65px;'>" + ClsManage.convert2Currency4((da.Rows(0)("sumEquipment_MaterailandSupplies") / da.Rows(0)("sumTotalRevenue")) * 100).ToString + "%</div></TD><TD align='right'><div style='width:110px'>" + ClsManage.convert2Currency3(e.Item.DataItem("sumEquipment_MaterailandSupplies") - da.Rows(0)("sumEquipment_MaterailandSupplies")).ToString + "</div></TD><TD align='right'><div style='width:65px;'>" + ClsManage.convert2PercenNoneZero(e.Item.DataItem("sumEquipment_MaterailandSupplies") - da.Rows(0)("sumEquipment_MaterailandSupplies"), e.Item.DataItem("sumTotalRevenue") - da.Rows(0)("sumTotalRevenue")).ToString + "%</div></TD></TR>" + _
"<TR id='h23c" + TbCk.Text + "'><TD align='right'><div style='width:110px'>" + ClsManage.convert2Currency3(da.Rows(0)("sumPrintingandStationery")).ToString + "</div></TD><TD align='right'><div style='width:65px;'>" + ClsManage.convert2Currency4((da.Rows(0)("sumPrintingandStationery") / da.Rows(0)("sumTotalRevenue")) * 100).ToString + "%</div></TD><TD align='right'><div style='width:110px'>" + ClsManage.convert2Currency3(e.Item.DataItem("sumPrintingandStationery") - da.Rows(0)("sumPrintingandStationery")).ToString + "</div></TD><TD align='right'><div style='width:65px;'>" + ClsManage.convert2PercenNoneZero(e.Item.DataItem("sumPrintingandStationery") - da.Rows(0)("sumPrintingandStationery"), e.Item.DataItem("sumTotalRevenue") - da.Rows(0)("sumTotalRevenue")).ToString + "%</div></TD></TR>" + _
"<TR id='h24c" + TbCk.Text + "'><TD align='right'><div style='width:110px'>" + ClsManage.convert2Currency3(da.Rows(0)("sumSuppliesExpenses")).ToString + "</div></TD><TD align='right'><div style='width:65px;'>" + ClsManage.convert2Currency4((da.Rows(0)("sumSuppliesExpenses") / da.Rows(0)("sumTotalRevenue")) * 100).ToString + "%</div></TD><TD align='right'><div style='width:110px'>" + ClsManage.convert2Currency3(e.Item.DataItem("sumSuppliesExpenses") - da.Rows(0)("sumSuppliesExpenses")).ToString + "</div></TD><TD align='right'><div style='width:65px;'>" + ClsManage.convert2PercenNoneZero(e.Item.DataItem("sumSuppliesExpenses") - da.Rows(0)("sumSuppliesExpenses"), e.Item.DataItem("sumTotalRevenue") - da.Rows(0)("sumTotalRevenue")).ToString + "%</div></TD></TR>" + _
"<TR id='h25c" + TbCk.Text + "'><TD align='right'><div style='width:110px'>" + ClsManage.convert2Currency3(da.Rows(0)("sumEquipment")).ToString + "</div></TD><TD align='right'><div style='width:65px;'>" + ClsManage.convert2Currency4((da.Rows(0)("sumEquipment") / da.Rows(0)("sumTotalRevenue")) * 100).ToString + "%</div></TD><TD align='right'><div style='width:110px'>" + ClsManage.convert2Currency3(e.Item.DataItem("sumEquipment") - da.Rows(0)("sumEquipment")).ToString + "</div></TD><TD align='right'><div style='width:65px;'>" + ClsManage.convert2PercenNoneZero(e.Item.DataItem("sumEquipment") - da.Rows(0)("sumEquipment"), e.Item.DataItem("sumTotalRevenue") - da.Rows(0)("sumTotalRevenue")).ToString + "%</div></TD></TR>" + _
"<TR id='h26c" + TbCk.Text + "'><TD align='right'><div style='width:110px'>" + ClsManage.convert2Currency3(da.Rows(0)("sumShopfitting")).ToString + "</div></TD><TD align='right'><div style='width:65px;'>" + ClsManage.convert2Currency4((da.Rows(0)("sumShopfitting") / da.Rows(0)("sumTotalRevenue")) * 100).ToString + "%</div></TD><TD align='right'><div style='width:110px'>" + ClsManage.convert2Currency3(e.Item.DataItem("sumShopfitting") - da.Rows(0)("sumShopfitting")).ToString + "</div></TD><TD align='right'><div style='width:65px;'>" + ClsManage.convert2PercenNoneZero(e.Item.DataItem("sumShopfitting") - da.Rows(0)("sumShopfitting"), e.Item.DataItem("sumTotalRevenue") - da.Rows(0)("sumTotalRevenue")).ToString + "%</div></TD></TR>" + _
"<TR id='h27c" + TbCk.Text + "'><TD align='right'><div style='width:110px'>" + ClsManage.convert2Currency3(da.Rows(0)("sumPackagingandOtherMaterial")).ToString + "</div></TD><TD align='right'><div style='width:65px;'>" + ClsManage.convert2Currency4((da.Rows(0)("sumPackagingandOtherMaterial") / da.Rows(0)("sumTotalRevenue")) * 100).ToString + "%</div></TD><TD align='right'><div style='width:110px'>" + ClsManage.convert2Currency3(e.Item.DataItem("sumPackagingandOtherMaterial") - da.Rows(0)("sumPackagingandOtherMaterial")).ToString + "</div></TD><TD align='right'><div style='width:65px;'>" + ClsManage.convert2PercenNoneZero(e.Item.DataItem("sumPackagingandOtherMaterial") - da.Rows(0)("sumPackagingandOtherMaterial"), e.Item.DataItem("sumTotalRevenue") - da.Rows(0)("sumTotalRevenue")).ToString + "%</div></TD></TR>" + _
"<TR id='h28c" + TbCk.Text + "'><TD align='right'><div style='width:110px'>" + ClsManage.convert2Currency3(da.Rows(0)("sumBusinessTravelExpenses")).ToString + "</div></TD><TD align='right'><div style='width:65px;'>" + ClsManage.convert2Currency4((da.Rows(0)("sumBusinessTravelExpenses") / da.Rows(0)("sumTotalRevenue")) * 100).ToString + "%</div></TD><TD align='right'><div style='width:110px'>" + ClsManage.convert2Currency3(e.Item.DataItem("sumBusinessTravelExpenses") - da.Rows(0)("sumBusinessTravelExpenses")).ToString + "</div></TD><TD align='right'><div style='width:65px;'>" + ClsManage.convert2PercenNoneZero(e.Item.DataItem("sumBusinessTravelExpenses") - da.Rows(0)("sumBusinessTravelExpenses"), e.Item.DataItem("sumTotalRevenue") - da.Rows(0)("sumTotalRevenue")).ToString + "%</div></TD></TR>" + _
"<TR id='h29c" + TbCk.Text + "'><TD align='right'><div style='width:110px'>" + ClsManage.convert2Currency3(da.Rows(0)("sumCarParkingandOthers")).ToString + "</div></TD><TD align='right'><div style='width:65px;'>" + ClsManage.convert2Currency4((da.Rows(0)("sumCarParkingandOthers") / da.Rows(0)("sumTotalRevenue")) * 100).ToString + "%</div></TD><TD align='right'><div style='width:110px'>" + ClsManage.convert2Currency3(e.Item.DataItem("sumCarParkingandOthers") - da.Rows(0)("sumCarParkingandOthers")).ToString + "</div></TD><TD align='right'><div style='width:65px;'>" + ClsManage.convert2PercenNoneZero(e.Item.DataItem("sumCarParkingandOthers") - da.Rows(0)("sumCarParkingandOthers"), e.Item.DataItem("sumTotalRevenue") - da.Rows(0)("sumTotalRevenue")).ToString + "%</div></TD></TR>" + _
"<TR id='h30c" + TbCk.Text + "'><TD align='right'><div style='width:110px'>" + ClsManage.convert2Currency3(da.Rows(0)("sumTravel")).ToString + "</div></TD><TD align='right'><div style='width:65px;'>" + ClsManage.convert2Currency4((da.Rows(0)("sumTravel") / da.Rows(0)("sumTotalRevenue")) * 100).ToString + "%</div></TD><TD align='right'><div style='width:110px'>" + ClsManage.convert2Currency3(e.Item.DataItem("sumTravel") - da.Rows(0)("sumTravel")).ToString + "</div></TD><TD align='right'><div style='width:65px;'>" + ClsManage.convert2PercenNoneZero(e.Item.DataItem("sumTravel") - da.Rows(0)("sumTravel"), e.Item.DataItem("sumTotalRevenue") - da.Rows(0)("sumTotalRevenue")).ToString + "%</div></TD></TR>" + _
"<TR id='h31c" + TbCk.Text + "'><TD align='right'><div style='width:110px'>" + ClsManage.convert2Currency3(da.Rows(0)("sumAccomodation")).ToString + "</div></TD><TD align='right'><div style='width:65px;'>" + ClsManage.convert2Currency4((da.Rows(0)("sumAccomodation") / da.Rows(0)("sumTotalRevenue")) * 100).ToString + "%</div></TD><TD align='right'><div style='width:110px'>" + ClsManage.convert2Currency3(e.Item.DataItem("sumAccomodation") - da.Rows(0)("sumAccomodation")).ToString + "</div></TD><TD align='right'><div style='width:65px;'>" + ClsManage.convert2PercenNoneZero(e.Item.DataItem("sumAccomodation") - da.Rows(0)("sumAccomodation"), e.Item.DataItem("sumTotalRevenue") - da.Rows(0)("sumTotalRevenue")).ToString + "%</div></TD></TR>" + _
...
"<TR id='h33c" + TbCk.Text + "'><TD align='right'><div style='width:110px'>" + ClsManage.convert2Currency3(da.Rows(0)("sumInsurance")).ToString + "</div></TD><TD align='right'><div style='width:65px;'>" + ClsManage.convert2Currency4((da.Rows(0)("sumInsurance") / da.Rows(0)("sumTotalRevenue")) * 100).ToString + "%</div></TD><TD align='right'><div style='width:110px'>" + ClsManage.convert2Currency3(e.Item.DataItem("sumInsurance") - da.Rows(0)("sumInsurance")).ToString + "</div></TD><TD align='right'><div style='width:65px;'>" + ClsManage.convert2PercenNoneZero(e.Item.DataItem("sumInsurance") - da.Rows(0)("sumInsurance"), e.Item.DataItem("sumTotalRevenue") - da.Rows(0)("sumTotalRevenue")).ToString + "%</div></TD></TR>" + _
"<TR id='h34c" + TbCk.Text + "'><TD align='right'><div style='width:110px'>" + ClsManage.convert2Currency3(da.Rows(0)("sumAllRiskInsurance")).ToString + "</div></TD><TD align='right'><div style='width:65px;'>" + ClsManage.convert2Currency4((da.Rows(0)("sumAllRiskInsurance") / da.Rows(0)("sumTotalRevenue")) * 100).ToString + "%</div></TD><TD align='right'><div style='width:110px'>" + ClsManage.convert2Currency3(e.Item.DataItem("sumAllRiskInsurance") - da.Rows(0)("sumAllRiskInsurance")).ToString + "</div></TD><TD align='right'><div style='width:65px;'>" + ClsManage.convert2PercenNoneZero(e.Item.DataItem("sumAllRiskInsurance") - da.Rows(0)("sumAllRiskInsurance"), e.Item.DataItem("sumTotalRevenue") - da.Rows(0)("sumTotalRevenue")).ToString + "%</div></TD></TR>" + _
"<TR id='h35c" + TbCk.Text + "'><TD align='right'><div style='width:110px'>" + ClsManage.convert2Currency3(da.Rows(0)("sumHealthandLifeInsurance")).ToString + "</div></TD><TD align='right'><div style='width:65px;'>" + ClsManage.convert2Currency4((da.Rows(0)("sumHealthandLifeInsurance") / da.Rows(0)("sumTotalRevenue")) * 100).ToString + "%</div></TD><TD align='right'><div style='width:110px'>" + ClsManage.convert2Currency3(e.Item.DataItem("sumHealthandLifeInsurance") - da.Rows(0)("sumHealthandLifeInsurance")).ToString + "</div></TD><TD align='right'><div style='width:65px;'>" + ClsManage.convert2PercenNoneZero(e.Item.DataItem("sumHealthandLifeInsurance") - da.Rows(0)("sumHealthandLifeInsurance"), e.Item.DataItem("sumTotalRevenue") - da.Rows(0)("sumTotalRevenue")).ToString + "%</div></TD></TR>" + _
"<TR id='h36c" + TbCk.Text + "'><TD align='right'><div style='width:110px'>" + ClsManage.convert2Currency3(da.Rows(0)("sumPenaltyandTaxation")).ToString + "</div></TD><TD align='right'><div style='width:65px;'>" + ClsManage.convert2Currency4((da.Rows(0)("sumPenaltyandTaxation") / da.Rows(0)("sumTotalRevenue")) * 100).ToString + "%</div></TD><TD align='right'><div style='width:110px'>" + ClsManage.convert2Currency3(e.Item.DataItem("sumPenaltyandTaxation") - da.Rows(0)("sumPenaltyandTaxation")).ToString + "</div></TD><TD align='right'><div style='width:65px;'>" + ClsManage.convert2PercenNoneZero(e.Item.DataItem("sumPenaltyandTaxation") - da.Rows(0)("sumPenaltyandTaxation"), e.Item.DataItem("sumTotalRevenue") - da.Rows(0)("sumTotalRevenue")).ToString + "%</div></TD></TR>" + _
"<TR id='h37c" + TbCk.Text + "'><TD align='right'><div style='width:110px'>" + ClsManage.convert2Currency3(da.Rows(0)("sumTaxation")).ToString + "</div></TD><TD align='right'><div style='width:65px;'>" + ClsManage.convert2Currency4((da.Rows(0)("sumTaxation") / da.Rows(0)("sumTotalRevenue")) * 100).ToString + "%</div></TD><TD align='right'><div style='width:110px'>" + ClsManage.convert2Currency3(e.Item.DataItem("sumTaxation") - da.Rows(0)("sumTaxation")).ToString + "</div></TD><TD align='right'><div style='width:65px;'>" + ClsManage.convert2PercenNoneZero(e.Item.DataItem("sumTaxation") - da.Rows(0)("sumTaxation"), e.Item.DataItem("sumTotalRevenue") - da.Rows(0)("sumTotalRevenue")).ToString + "%</div></TD></TR>" + _
"<TR id='h38c" + TbCk.Text + "'><TD align='right'><div style='width:110px'>" + ClsManage.convert2Currency3(da.Rows(0)("sumPenalty")).ToString + "</div></TD><TD align='right'><div style='width:65px;'>" + ClsManage.convert2Currency4((da.Rows(0)("sumPenalty") / da.Rows(0)("sumTotalRevenue")) * 100).ToString + "%</div></TD><TD align='right'><div style='width:110px'>" + ClsManage.convert2Currency3(e.Item.DataItem("sumPenalty") - da.Rows(0)("sumPenalty")).ToString + "</div></TD><TD align='right'><div style='width:65px;'>" + ClsManage.convert2PercenNoneZero(e.Item.DataItem("sumPenalty") - da.Rows(0)("sumPenalty"), e.Item.DataItem("sumTotalRevenue") - da.Rows(0)("sumTotalRevenue")).ToString + "%</div></TD></TR>" + _
"<TR id='h39c" + TbCk.Text + "'><TD align='right'><div style='width:110px'>" + ClsManage.convert2Currency3(da.Rows(0)("sumOtherRelatedStaffCost")).ToString + "</div></TD><TD align='right'><div style='width:65px;'>" + ClsManage.convert2Currency4((da.Rows(0)("sumOtherRelatedStaffCost") / da.Rows(0)("sumTotalRevenue")) * 100).ToString + "%</div></TD><TD align='right'><div style='width:110px'>" + ClsManage.convert2Currency3(e.Item.DataItem("sumOtherRelatedStaffCost") - da.Rows(0)("sumOtherRelatedStaffCost")).ToString + "</div></TD><TD align='right'><div style='width:65px;'>" + ClsManage.convert2PercenNoneZero(e.Item.DataItem("sumOtherRelatedStaffCost") - da.Rows(0)("sumOtherRelatedStaffCost"), e.Item.DataItem("sumTotalRevenue") - da.Rows(0)("sumTotalRevenue")).ToString + "%</div></TD></TR>" + _
"<TR id='h40c" + TbCk.Text + "'><TD align='right'><div style='width:110px'>" + ClsManage.convert2Currency3(da.Rows(0)("sumStaffConferenceandTraining")).ToString + "</div></TD><TD align='right'><div style='width:65px;'>" + ClsManage.convert2Currency4((da.Rows(0)("sumStaffConferenceandTraining") / da.Rows(0)("sumTotalRevenue")) * 100).ToString + "%</div></TD><TD align='right'><div style='width:110px'>" + ClsManage.convert2Currency3(e.Item.DataItem("sumStaffConferenceandTraining") - da.Rows(0)("sumStaffConferenceandTraining")).ToString + "</div></TD><TD align='right'><div style='width:65px;'>" + ClsManage.convert2PercenNoneZero(e.Item.DataItem("sumStaffConferenceandTraining") - da.Rows(0)("sumStaffConferenceandTraining"), e.Item.DataItem("sumTotalRevenue") - da.Rows(0)("sumTotalRevenue")).ToString + "%</div></TD></TR>" + _
"<TR id='h41c" + TbCk.Text + "'><TD align='right'><div style='width:110px'>" + ClsManage.convert2Currency3(da.Rows(0)("sumTraining")).ToString + "</div></TD><TD align='right'><div style='width:65px;'>" + ClsManage.convert2Currency4((da.Rows(0)("sumTraining") / da.Rows(0)("sumTotalRevenue")) * 100).ToString + "%</div></TD><TD align='right'><div style='width:110px'>" + ClsManage.convert2Currency3(e.Item.DataItem("sumTraining") - da.Rows(0)("sumTraining")).ToString + "</div></TD><TD align='right'><div style='width:65px;'>" + ClsManage.convert2PercenNoneZero(e.Item.DataItem("sumTraining") - da.Rows(0)("sumTraining"), e.Item.DataItem("sumTotalRevenue") - da.Rows(0)("sumTotalRevenue")).ToString + "%</div></TD></TR>" + _
"<TR id='h42c" + TbCk.Text + "'><TD align='right'><div style='width:110px'>" + ClsManage.convert2Currency3(da.Rows(0)("sumCommunication")).ToString + "</div></TD><TD align='right'><div style='width:65px;'>" + ClsManage.convert2Currency4((da.Rows(0)("sumCommunication") / da.Rows(0)("sumTotalRevenue")) * 100).ToString + "%</div></TD><TD align='right'><div style='width:110px'>" + ClsManage.convert2Currency3(e.Item.DataItem("sumCommunication") - da.Rows(0)("sumCommunication")).ToString + "</div></TD><TD align='right'><div style='width:65px;'>" + ClsManage.convert2PercenNoneZero(e.Item.DataItem("sumCommunication") - da.Rows(0)("sumCommunication"), e.Item.DataItem("sumTotalRevenue") - da.Rows(0)("sumTotalRevenue")).ToString + "%</div></TD></TR>" + _
"<TR id='h43c" + TbCk.Text + "'><TD align='right'><div style='width:110px'>" + ClsManage.convert2Currency3(da.Rows(0)("sumTelephoneCalls_Faxes")).ToString + "</div></TD><TD align='right'><div style='width:65px;'>" + ClsManage.convert2Currency4((da.Rows(0)("sumTelephoneCalls_Faxes") / da.Rows(0)("sumTotalRevenue")) * 100).ToString + "%</div></TD><TD align='right'><div style='width:110px'>" + ClsManage.convert2Currency3(e.Item.DataItem("sumTelephoneCalls_Faxes") - da.Rows(0)("sumTelephoneCalls_Faxes")).ToString + "</div></TD><TD align='right'><div style='width:65px;'>" + ClsManage.convert2PercenNoneZero(e.Item.DataItem("sumTelephoneCalls_Faxes") - da.Rows(0)("sumTelephoneCalls_Faxes"), e.Item.DataItem("sumTotalRevenue") - da.Rows(0)("sumTotalRevenue")).ToString + "%</div></TD></TR>" + _
"<TR id='h44c" + TbCk.Text + "'><TD align='right'><div style='width:110px'>" + ClsManage.convert2Currency3(da.Rows(0)("sumPostageandCourier")).ToString + "</div></TD><TD align='right'><div style='width:65px;'>" + ClsManage.convert2Currency4((da.Rows(0)("sumPostageandCourier") / da.Rows(0)("sumTotalRevenue")) * 100).ToString + "%</div></TD><TD align='right'><div style='width:110px'>" + ClsManage.convert2Currency3(e.Item.DataItem("sumPostageandCourier") - da.Rows(0)("sumPostageandCourier")).ToString + "</div></TD><TD align='right'><div style='width:65px;'>" + ClsManage.convert2PercenNoneZero(e.Item.DataItem("sumPostageandCourier") - da.Rows(0)("sumPostageandCourier"), e.Item.DataItem("sumTotalRevenue") - da.Rows(0)("sumTotalRevenue")).ToString + "%</div></TD></TR>" + _
"<TR id='h45c" + TbCk.Text + "'><TD align='right'><div style='width:110px'>" + ClsManage.convert2Currency3(da.Rows(0)("sumOtherExpenses")).ToString + "</div></TD><TD align='right'><div style='width:65px;'>" + ClsManage.convert2Currency4((da.Rows(0)("sumOtherExpenses") / da.Rows(0)("sumTotalRevenue")) * 100).ToString + "%</div></TD><TD align='right'><div style='width:110px'>" + ClsManage.convert2Currency3(e.Item.DataItem("sumOtherExpenses") - da.Rows(0)("sumOtherExpenses")).ToString + "</div></TD><TD align='right'><div style='width:65px;'>" + ClsManage.convert2PercenNoneZero(e.Item.DataItem("sumOtherExpenses") - da.Rows(0)("sumOtherExpenses"), e.Item.DataItem("sumTotalRevenue") - da.Rows(0)("sumTotalRevenue")).ToString + "%</div></TD></TR>" + _
"<TR id='h46c" + TbCk.Text + "'><TD align='right'><div style='width:110px'>" + ClsManage.convert2Currency3(da.Rows(0)("sumSample_Tester")).ToString + "</div></TD><TD align='right'><div style='width:65px;'>" + ClsManage.convert2Currency4((da.Rows(0)("sumSample_Tester") / da.Rows(0)("sumTotalRevenue")) * 100).ToString + "%</div></TD><TD align='right'><div style='width:110px'>" + ClsManage.convert2Currency3(e.Item.DataItem("sumSample_Tester") - da.Rows(0)("sumSample_Tester")).ToString + "</div></TD><TD align='right'><div style='width:65px;'>" + ClsManage.convert2PercenNoneZero(e.Item.DataItem("sumSample_Tester") - da.Rows(0)("sumSample_Tester"), e.Item.DataItem("sumTotalRevenue") - da.Rows(0)("sumTotalRevenue")).ToString + "%</div></TD></TR>" + _
"<TR id='h47c" + TbCk.Text + "'><TD align='right'><div style='width:110px'>" + ClsManage.convert2Currency3(da.Rows(0)("sumPreopeningCosts")).ToString + "</div></TD><TD align='right'><div style='width:65px;'>" + ClsManage.convert2Currency4((da.Rows(0)("sumPreopeningCosts") / da.Rows(0)("sumTotalRevenue")) * 100).ToString + "%</div></TD><TD align='right'><div style='width:110px'>" + ClsManage.convert2Currency3(e.Item.DataItem("sumPreopeningCosts") - da.Rows(0)("sumPreopeningCosts")).ToString + "</div></TD><TD align='right'><div style='width:65px;'>" + ClsManage.convert2PercenNoneZero(e.Item.DataItem("sumPreopeningCosts") - da.Rows(0)("sumPreopeningCosts"), e.Item.DataItem("sumTotalRevenue") - da.Rows(0)("sumTotalRevenue")).ToString + "%</div></TD></TR>" + _
"<TR id='h48c" + TbCk.Text + "'><TD align='right'><div style='width:110px'>" + ClsManage.convert2Currency3(da.Rows(0)("sumLossonClaim")).ToString + "</div></TD><TD align='right'><div style='width:65px;'>" + ClsManage.convert2Currency4((da.Rows(0)("sumLossonClaim") / da.Rows(0)("sumTotalRevenue")) * 100).ToString + "%</div></TD><TD align='right'><div style='width:110px'>" + ClsManage.convert2Currency3(e.Item.DataItem("sumLossonClaim") - da.Rows(0)("sumLossonClaim")).ToString + "</div></TD><TD align='right'><div style='width:65px;'>" + ClsManage.convert2PercenNoneZero(e.Item.DataItem("sumLossonClaim") - da.Rows(0)("sumLossonClaim"), e.Item.DataItem("sumTotalRevenue") - da.Rows(0)("sumTotalRevenue")).ToString + "%</div></TD></TR>" + _
"<TR id='h49c" + TbCk.Text + "'><TD align='right'><div style='width:110px'>" + ClsManage.convert2Currency3(da.Rows(0)("sumCashOvertage_Shortagefromsales")).ToString + "</div></TD><TD align='right'><div style='width:65px;'>" + ClsManage.convert2Currency4((da.Rows(0)("sumCashOvertage_Shortagefromsales") / da.Rows(0)("sumTotalRevenue")) * 100).ToString + "%</div></TD><TD align='right'><div style='width:110px'>" + ClsManage.convert2Currency3(e.Item.DataItem("sumCashOvertage_Shortagefromsales") - da.Rows(0)("sumCashOvertage_Shortagefromsales")).ToString + "</div></TD><TD align='right'><div style='width:65px;'>" + ClsManage.convert2PercenNoneZero(e.Item.DataItem("sumCashOvertage_Shortagefromsales") - da.Rows(0)("sumCashOvertage_Shortagefromsales"), e.Item.DataItem("sumTotalRevenue") - da.Rows(0)("sumTotalRevenue")).ToString + "%</div></TD></TR>" + _
"<TR id='h50c" + TbCk.Text + "'><TD align='right'><div style='width:110px'>" + ClsManage.convert2Currency3(da.Rows(0)("sumMiscellenousandOther")).ToString + "</div></TD><TD align='right'><div style='width:65px;'>" + ClsManage.convert2Currency4((da.Rows(0)("sumMiscellenousandOther") / da.Rows(0)("sumTotalRevenue")) * 100).ToString + "%</div></TD><TD align='right'><div style='width:110px'>" + ClsManage.convert2Currency3(e.Item.DataItem("sumMiscellenousandOther") - da.Rows(0)("sumMiscellenousandOther")).ToString + "</div></TD><TD align='right'><div style='width:65px;'>" + ClsManage.convert2PercenNoneZero(e.Item.DataItem("sumMiscellenousandOther") - da.Rows(0)("sumMiscellenousandOther"), e.Item.DataItem("sumTotalRevenue") - da.Rows(0)("sumTotalRevenue")).ToString + "%</div></TD></TR>" + _
"<TR style='font-weight:bold;' class='kbg5'><TD align='right'><div style='width:110px'>" + ClsManage.convert2Currency3(da.Rows(0)("sumStoreTradingProfit__Loss")).ToString + "</div></TD><TD align='right'><div style='width:65px;'>" + ClsManage.convert2Currency4((da.Rows(0)("sumStoreTradingProfit__Loss") / da.Rows(0)("sumTotalRevenue")) * 100).ToString + "%</div></TD><TD align='right'><div style='width:110px'>" + ClsManage.convert2Currency3(e.Item.DataItem("sumStoreTradingProfit__Loss") - da.Rows(0)("sumStoreTradingProfit__Loss")).ToString + "</div></TD><TD align='right'><div style='width:65px;'>" + ClsManage.convert2PercenNoneZero(e.Item.DataItem("sumStoreTradingProfit__Loss") - da.Rows(0)("sumStoreTradingProfit__Loss"), e.Item.DataItem("sumTotalRevenue") - da.Rows(0)("sumTotalRevenue")).ToString + "%</div></TD></TR>" + _
"</TABLE>"
