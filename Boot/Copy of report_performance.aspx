<%@ Page Title="" Language="VB" MasterPageFile="~/MasterPage.master" AutoEventWireup="false"
    MaintainScrollPositionOnPostback="true" CodeFile="Copy of report_performance.aspx.vb"
...
<asp:Content ID="Content1" ContentPlaceHolderID="head" runat="Server">
    ...
    <script language="javascript" type="text/javascript">
        ...
        function pageLoad() {
            if ($get('<%=ddlBy.ClientId %>').selectedIndex == 2) {
                                    ...
                                    <asp:UpdateProgress ID="upPG" runat="server">
                                        <ProgressTemplate>
                                            <div id="divPG" align="center" valign="middle" runat="server" style="position: absolute;
                                                left: 47%; padding: 0px 10px 10px 10px; visibility: visible; border-color: silver;
        ...
        <asp:UpdatePanel ID="upGv" runat="server">
            <ContentTemplate>
                <asp:GridView ID="gv" runat="server" AutoGenerateColumns="False" Font-Bold="False"
                    Width="800px" GridLines="Vertical" Font-Names="Tahoma" Font-Size="10pt" CellPadding="1"
                    HeaderStyle-Height="60px" CellSpacing="1">
                    <Columns>
