...
Partial Class mtd_market_report
    Inherits basePage
    ...
    Protected Sub DataList2_ItemDataBound(ByVal sender As Object, ByVal e As System.Web.UI.WebControls.DataListItemEventArgs) Handles DataList2.ItemDataBound
        ...
        "<TR style='font-weight:bold;' class='kbg1'><TD align='center'><div style='width:110px'><strong>" + e.Item.DataItem("market_name") + "</strong></div></TD><TD align='center'><div style='width:65px;'><strong>% Sale</strong></div></TD></TR>" + _
    "<TR style='font-weight:bold;'><TD align='center'><div style='width:110px'>" + ClsManage.convert2Currency2(e.Item.DataItem("sumtotalarea").ToString).ToString + "</div></TD><TD align='center'><div style='width:65px;'>&nbsp;</div></TD></TR>" + _
    "<TR style='font-weight:bold;'><TD align='center'><div style='width:110px'>" + ClsManage.convert2Currency2(e.Item.DataItem("sumsalearea").ToString).ToString + "</div></TD><TD align='center'><div style='width:65px;'>&nbsp;</div></TD></TR>" + _
    "<TR style='font-weight:bold;'><TD align='center'><div style='width:110px'>" + ClsManage.convert2Currency2(e.Item.DataItem("SumTotalRevenue") / e.Item.DataItem("sumsalearea")).ToString + "</div></TD><TD align='center'><div style='width:65px;'>&nbsp;</div></TD></TR>" + _
    "<TR style='font-weight:bold;'><TD align='center'><div style='width:110px'>" + MonthName(ddlMonth.SelectedValue, True).ToString + " " + ddlYear.SelectedValue.ToString() + "</div></TD><TD align='center'><div style='width:65px;'>&nbsp;</div></TD></TR>" + _
    ...
    "<TR style='font-weight:bold;'><TD align='right'><div style='width:110px'>" + ClsManage.convert2Currency3(e.Item.DataItem("SumGrossProfit").ToString).ToString + "</div></TD><TD align='right'><div style='width:65px;'>" + ClsManage.convert2Currency4((e.Item.DataItem("SumGrossProfit") / e.Item.DataItem("SumTotalRevenue")) * 100).ToString + "%</div></TD></TR>" + _
