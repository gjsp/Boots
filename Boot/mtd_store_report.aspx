<%@ Page Title="" Language="VB" MasterPageFile="~/MasterPage.master" AutoEventWireup="false" CodeFile="mtd_store_report.aspx.vb" Inherits="mtd_store_report" %>
...
<asp:Content ID="Content2" ContentPlaceHolderID="ContentPlaceHolder1" Runat="Server">
    <div style="padding: 10px 10px;">
        <strong>Store report</strong><br /><br>
        <div style="float:left; margin-right:.5cm">
         Store : <asp:DropDownList ID="ddlstore" runat="server" CssClass="select2">
        </asp:DropDownList>
         </div>
         <div style="float:left; margin-right:.5cm">
    ...
    <div style="padding-left:5px;"><asp:Label ID="LbNameCo" runat="server" Text=""></asp:Label></div>
    <asp:Panel ID="Panel1" runat="server">
    <br />
    <asp:LinkButton ID="linkExcel" runat="server" style="color:#37a700;">Export To Export</asp:LinkButton>
    <br /><br />
...
<div class="scroll">
    ...
    SelectMethod="getSumFullMtdByCost" TypeName="ClsDB" 
