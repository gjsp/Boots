...
Partial Class mtd_store_report
    Inherits basePage
    ...
    Protected Sub ddlYear2_TextChanged(ByVal sender As Object, ByVal e As System.EventArgs) Handles ddlYear2.TextChanged
        ddlMonth2.DataValueField = "mon_year"
        ddlMonth2.DataTextField = "mon_name"
        ddlMonth2.DataSource = ClsDB.getMtdMonth(ddlYear.SelectedValue)
        ddlMonth2.DataBind()
    ...
    Protected Sub SearchBt_Click(ByVal sender As Object, ByVal e As System.EventArgs) Handles SearchBt.Click
        ...
        dd = ClsDB.getCostcenterByid(ddlstore.SelectedValue)
        TbCD.Text = dd.Rows(0)("costcenter_Code").ToString
        LbNameCo.Text = dd.Rows(0)("costcenter_name").ToString
        Panel1.Visible = True
        Pftb.Visible = True
        TbCk.Text = 0
        TbCk2.Text = 0
        ...
        ObjectDataSource2.SelectParameters("fdate").DefaultValue = ddlMonth.SelectedValue + "/" + ddlYear.SelectedValue
        ObjectDataSource2.SelectParameters("tdate").DefaultValue = ddlMonth2.SelectedValue + "/" + ddlYear2.SelectedValue
        ObjectDataSource2.SelectParameters("cost_id").DefaultValue = ddlstore.SelectedValue
        ...
        If LbSumTotalRevenue.Text <> 0 Then
            ...
            If LbFullTss.Text = "0.00" Then
                LbFullPos.Text = "0.00"
            Else
                LbFullPos.Text = ClsManage.convert2Currency((Convert.ToDecimal(LbSumTotalRevenue.Text) / Convert.ToDecimal(LbFullTss.Text)) / mdiff)
            End If
    ...
    Protected Sub DataList2_ItemDataBound(ByVal sender As Object, ByVal e As System.Web.UI.WebControls.DataListItemEventArgs) Handles DataList2.ItemDataBound
        ...
        TbCk2.Text = Convert.ToDecimal(TbCk2.Text) + 1
        CType(e.Item.FindControl("label2"), Label).Text = "<TABLE cellspacing='0' cellpadding='0' class='tball'>" + _
    "<TR style='font-weight:bold;' class='kbg1'><TD align='center'><div style='width:110px'><strong>" + TbCD.Text + "</strong></div></TD><TD align='center'><div style='width:65px;'><strong>% Sale</strong></div></TD></TR>" + _
    ...
    "<TR style='font-weight:bold;'><TD align='center'><div style='width:110px'>" + ClsManage.convert2NoneZero(e.Item.DataItem("SumTotalRevenue").ToString, e.Item.DataItem("sumsalearea")).ToString + "</div></TD><TD align='center'><div style='width:65px;'>&nbsp;</div></TD></TR>" + _
    "<TR style='font-weight:bold;'><TD align='center'><div style='width:110px'>" + DateValue(e.Item.DataItem("month_time")).ToString("MMMM yyyy") + "</div></TD><TD align='center'><div style='width:65px;'>&nbsp;</div></TD></TR>" + _
    ...
    "</TABLE>"
        ...
        LbFullTgs.Text = ClsManage.convert2Currency(e.Item.DataItem("sumtotalarea")).ToString
        LbFullTss.Text = ClsManage.convert2Currency(e.Item.DataItem("sumsalearea")).ToString
        TbCSale.Text = ClsManage.convert2Currency(Convert.ToDecimal(LbFullTss.Text) + e.Item.DataItem("sumsalearea")).ToString
