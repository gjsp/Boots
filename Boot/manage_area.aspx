<%@ Page Title="" Language="VB" MasterPageFile="~/MasterPage.master" AutoEventWireup="false" CodeFile="manage_area.aspx.vb" Inherits="manage_area" %>
...
<ContentTemplate>
    ...
    <div><strong>Manage Area</strong><br /><br /></div>
    <div><asp:Button ID="AddNewBt" runat="server" Text="Add New Area" /></div>
    ...
    <div style="padding-top:10px;">
        ...
        <asp:ObjectDataSource ID="ObjectDataSource1" runat="server" 
            SelectMethod="getArea" TypeName="ClsDB"></asp:ObjectDataSource>
        <br />
    </div>
</div>
</ContentTemplate>
