...
Partial Class lfl_ytd_report
    ...
    Protected Sub linkExcel_Click(ByVal sender As Object, ByVal e As System.EventArgs) Handles linkExcel.Click
        ...
        Dim excelName As String = "YTD_LFL_Report_" + ddlMonth.SelectedValue + ddlYear.SelectedValue
    ...
    Protected Sub DataList2_ItemDataBound(ByVal sender As Object, ByVal e As System.Web.UI.WebControls.DataListItemEventArgs) Handles DataList2.ItemDataBound
        ...
        "<TR style='font-weight:bold;'><TD align='center'><div style='width:110px'>" + ClsManage.convert2NoneZero(ClsManage.convert2NoneZero(e.Item.DataItem("SumTotalRevenue").ToString, e.Item.DataItem("sumsalearea")), x_divide).ToString + "</div></TD><TD align='center'><div style='width:65px;'>&nbsp;</div></TD></TR>" + _
        ...
        "</TABLE>"
            If e.Item.DataItem("sumTotalRevenue").ToString <> "" Then
                'LbSumTotalRevenue.Text = ClsManage.convert2Currency(e.Item.DataItem("sumTotalRevenue")).ToString
