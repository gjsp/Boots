<%@ Page Title="" Language="VB" MasterPageFile="~/MasterPage.master" AutoEventWireup="false" CodeFile="manage_location.aspx.vb" Inherits="manage_location" %>
...
<ContentTemplate>
    ...
    <div><strong>Manage Location</strong><br /><br /></div>
    <div><asp:Button ID="AddNewBt" runat="server" Text="Add New Location" /></div>
    <asp:Panel ID="Panel1" runat="server">
     ...
     <asp:Panel ID="Panel2" runat="server">
            <div style="padding-top:10px;">
                <asp:Label ID="Label2" runat="server" CssClass="lbtitle" Text="Edit"></asp:Label> <asp:TextBox ID="EditTxt" runat="server" CssClass="inputbox4"></asp:TextBox>  Active 
    ...
    <div style="padding-top:10px;">
        <asp:GridView ID="GridView1" runat="server" AutoGenerateColumns="False" 
            ...
            <Columns>
                ...
                <ItemStyle CssClass="ktb1" />
                 ...
                 <asp:BoundField DataField="location_active" HeaderText="Active">
        ...
        <asp:ObjectDataSource ID="ObjectDataSource1" runat="server" 
            SelectMethod="getLocation" TypeName="ClsDB"></asp:ObjectDataSource>
        <br />
    </div>
</div>
</ContentTemplate>
