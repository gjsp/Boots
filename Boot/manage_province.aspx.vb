...
Partial Class manage_province
    ...
    Protected Sub Imgedit_Click(ByVal sender As Object, ByVal e As System.Web.UI.ImageClickEventArgs)
        ...
        daStore = ClsDB.getProvinceById(id)

        EditTxt.Text = daStore.Rows(0)("province_name").ToString
        HdID.Value = id
    ...
    Function saveData() As Boolean
        Try
            ClsDB.InsertProvince(AddTxt.Text)
            Return True
    ...
    Protected Sub AddBt_Click(ByVal sender As Object, ByVal e As System.EventArgs) Handles AddBt.Click
        Try
            If saveData() Then
                ClsManage.alert(Page, "Save Complete", , "manage_province.aspx")
            End If
        Catch ex As Exception
            ClsManage.alert(Page, ex.Message)
        End Try
    ...
    Function updateData() As Boolean
        Try
            ClsDB.UpdateProvince(HdID.Value, EditTxt.Text)
            Return True
        Catch ex As Exception
            ClsManage.alert(Page, ex.Message)
        End Try
