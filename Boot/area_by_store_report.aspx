<%@ Page Title="" Language="VB" MasterPageFile="~/MasterPage.master" AutoEventWireup="false" CodeFile="area_by_store_report.aspx.vb" Inherits="area_by_store_report" %>
...
<asp:Content ID="Content2" ContentPlaceHolderID="ContentPlaceHolder1" Runat="Server">
    <div style="padding: 10px 10px;">
        <strong>Area By Store report</strong><br /><br>
...
<tr style='font-weight:bold;' class='kbg5'><td align='left'><div style="width:200px;padding-left:5px;" class="pptk">Gross Profit</div></td><td align='right'><div style='width:110px'><asp:Label ID="LbSumGrossProfit" runat="server" Text=""></asp:Label></div></td><td align='right'><div style='width:65px;'><asp:Label ID="LbPercGrossProfit" runat="server" Text=""></asp:Label>%</div></td></tr>
...
<div class="scroll">
    ...
    SelectMethod="getSumFullModelByArea" TypeName="ClsDB" 
