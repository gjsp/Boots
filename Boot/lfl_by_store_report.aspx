<%@ Page Title="" Language="VB" MasterPageFile="~/MasterPage.master" AutoEventWireup="false" CodeFile="lfl_by_store_report.aspx.vb" Inherits="lfl_by_store_report" %>
...
<asp:UpdatePanel id="upMain" runat="server">
    ...
    <div style="padding: 10px 10px;">
       ...
       <span style="font-size:11px">
        ...
        <br />
         <div style="float:left; margin-right:.5cm">
        From :<asp:DropDownList ID="ddlYear" runat="server" CssClass="select2" 
            AutoPostBack="True">
        </asp:DropDownList>
...
<tr style='font-weight:bold;' class='kbg5'><td align='left'><div style="width:200px;padding-left:5px;" class="pptk">
    Gross Retails Profit</div></td><td align='right'><div style='width:110px'><asp:Label ID="LbSumGrossProfit" runat="server" Text=""></asp:Label></div></td><td align='right'><div style='width:65px;'><asp:Label ID="LbPercGrossProfit" runat="server" Text=""></asp:Label>%</div></td></tr>
...
<div class="scroll">
    ...
    SelectMethod="getSumFullMtdLflByStore" TypeName="ClsDB" 
        OldValuesParameterFormatString="original_{0}">
    <SelectParameters>
        <asp:Parameter Name="years" Type="String" />
        <asp:Parameter Name="mon" Type="String" />
        <asp:Parameter Name="years2" Type="String" />
        <asp:Parameter Name="mon2" Type="String" />
