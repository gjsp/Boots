<%@ Page Title="" Language="VB" MasterPageFile="~/MasterPage.master" AutoEventWireup="false" CodeFile="report_province.aspx.vb" Inherits="report_province" EnableEventValidation="true" %>


<%@ Register src="uc/ucProvince.ascx" tagname="ucProvince" tagprefix="uc1" %>
...
<asp:Content ID="Content2" ContentPlaceHolderID="ContentPlaceHolder1" Runat="Server">
    ...
    <div style="padding: 10px 10px;">
        <strong>Province By Store Report</strong>
