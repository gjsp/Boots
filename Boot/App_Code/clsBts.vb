...
#Region "columnMtd"
    Public Shared Function columnModelSum2() As String
    ...
    Public Shared Function columnModelSum() As String 'Add ISNULL From columnModelSum2
        Dim col As New StringBuilder
        col.Append("ISNULL(SUM(TotalRevenue),0) as SumTotalRevenue, ")
        col.Append("ISNULL(SUM(RETAIL_TESPIncome),0) as SumRETAIL_TESPIncome, ")
        col.Append("ISNULL(SUM(OtherRevenue),0) as SumOtherRevenue, ")
        col.Append("ISNULL(SUM(CostofGoodSold),0) as SumCostofGoodSold, ")
        col.Append("ISNULL(SUM(GrossProfit),0) as SumGrossProfit, ")
        'col.Append("ISNULL(SUM(GrossProfit_percent),0) as SumGrossProfit_percent, ")
        col.Append("ISNULL(SUM(MarginAdjustments),0) as SumMarginAdjustments, ")
        col.Append("ISNULL(SUM(Shipping),0) as SumShipping, ")
        col.Append("ISNULL(SUM(StockLossandObsolescence),0) as SumStockLossandObsolescence, ")
        col.Append("ISNULL(SUM(InventoryAdjustment_stock),0) as SumInventoryAdjustment_stock, ")
        col.Append("ISNULL(SUM(InventoryAdjustment_damage),0) as SumInventoryAdjustment_damage, ")
        col.Append("ISNULL(SUM(StockLoss_Provision),0) as SumStockLoss_Provision, ")
        col.Append("ISNULL(SUM(StockObsolescence_Provision),0) as SumStockObsolescence_Provision, ")
        col.Append("ISNULL(SUM(GWP),0) as SumGWP, ")
        col.Append("ISNULL(SUM(GWPs_Corporate),0) as SumGWPs_Corporate, ")
        col.Append("ISNULL(SUM(GWPs_Transferred),0) as SumGWPs_Transferred, ")
        col.Append("ISNULL(SUM(SellingCosts),0) as SumSellingCosts, ")
        col.Append("ISNULL(SUM(Creditcardscommission),0) as SumCreditcardscommission, ")
        col.Append("ISNULL(SUM(LabellingMaterial),0) as SumLabellingMaterial, ")
        col.Append("ISNULL(SUM(OtherIncome_COSHFunding),0) as SumOtherIncome_COSHFunding, ")
        col.Append("ISNULL(SUM(OtherIncomeSupplier),0) as SumOtherIncomeSupplier, ")
        col.Append("ISNULL(SUM(AdjustedGrossMargin),0) as SumAdjustedGrossMargin, ")
        col.Append("ISNULL(SUM(SupplyChainCosts),0) as SumSupplyChainCosts, ")
        col.Append("ISNULL(SUM(TotalStoreExpenses),0) as SumTotalStoreExpenses, ")
        col.Append("ISNULL(SUM(StoreLabourCosts),0) as SumStoreLabourCosts, ")
        col.Append("ISNULL(SUM(GrossPay),0) as SumGrossPay, ")
        col.Append("ISNULL(SUM(TemporaryStaffCosts),0) as SumTemporaryStaffCosts, ")
        col.Append("ISNULL(SUM(Allowance),0) as SumAllowance, ")
        col.Append("ISNULL(SUM(Overtime),0) as SumOvertime, ")
        col.Append("ISNULL(SUM(Licensefee),0) as SumLicensefee, ")
        col.Append("ISNULL(SUM(Bonuses_Incentives),0) as SumBonuses_Incentives, ")
        col.Append("ISNULL(SUM(BootsBrandncentives),0) as SumBootsBrandncentives, ")
        col.Append("ISNULL(SUM(SuppliersIncentive),0) as SumSuppliersIncentive, ")
        col.Append("ISNULL(SUM(ProvidentFund),0) as SumProvidentFund, ")
        col.Append("ISNULL(SUM(PensionCosts),0) as SumPensionCosts, ")
        col.Append("ISNULL(SUM(SocialSecurityFund),0) as SumSocialSecurityFund, ")
        col.Append("ISNULL(SUM(Uniforms),0) as SumUniforms, ")
        col.Append("ISNULL(SUM(EmployeeWelfare),0) as SumEmployeeWelfare, ")
        col.Append("ISNULL(SUM(OtherBenefitsEmployee),0) as SumOtherBenefitsEmployee, ")
        col.Append("ISNULL(SUM(StorePropertyCosts),0) as SumStorePropertyCosts, ")
        col.Append("ISNULL(SUM(PropertyRental),0) as SumPropertyRental, ")
        col.Append("ISNULL(SUM(PropertyServices),0) as SumPropertyServices, ")
        col.Append("ISNULL(SUM(PropertyFacility),0) as SumPropertyFacility, ")
        col.Append("ISNULL(SUM(Propertytaxes),0) as SumPropertytaxes, ")
        col.Append("ISNULL(SUM(Facialtaxes),0) as SumFacialtaxes, ")
        col.Append("ISNULL(SUM(PropertyInsurance),0) as SumPropertyInsurance, ")
        col.Append("ISNULL(SUM(Signboard),0) as SumSignboard, ")
        col.Append("ISNULL(SUM(Discount_Rent_Services_Facility),0) as SumDiscount_Rent_Services_Facility, ")
        col.Append("ISNULL(SUM(GPCommission),0) as SumGPCommission, ")
        col.Append("ISNULL(SUM(AmortizationofLeaseRight),0) as SumAmortizationofLeaseRight, ")
        col.Append("ISNULL(SUM(Depreciation),0) as SumDepreciation, ")
        col.Append("ISNULL(SUM(DepreciationofShortLeaseBuilding),0) as SumDepreciationofShortLeaseBuilding, ")
        col.Append("ISNULL(SUM(DepreciationofComputerHardware),0) as SumDepreciationofComputerHardware, ")
        col.Append("ISNULL(SUM(DepreciationofFixturesFittings),0) as SumDepreciationofFixturesFittings, ")
        col.Append("ISNULL(SUM(DepreciationofComputerSoftware),0) as SumDepreciationofComputerSoftware, ")
        col.Append("ISNULL(SUM(DepreciationofOfficeEquipment),0) as SumDepreciationofOfficeEquipment, ")
        col.Append("ISNULL(SUM(OtherStoreCosts),0) as SumOtherStoreCosts, ")
        col.Append("ISNULL(SUM(ServiceChargesandOtherFees),0) as SumServiceChargesandOtherFees, ")
        col.Append("ISNULL(SUM(BankCharges),0) as SumBankCharges, ")
        col.Append("ISNULL(SUM(CashCollectionCharge),0) as SumCashCollectionCharge, ")
        col.Append("ISNULL(SUM(Cleaning),0) as SumCleaning, ")
        col.Append("ISNULL(SUM(SecurityGuards),0) as SumSecurityGuards, ")
        col.Append("ISNULL(SUM(Carriage),0) as SumCarriage, ")
        col.Append("ISNULL(SUM(LicenceFees),0) as SumLicenceFees, ")
        col.Append("ISNULL(SUM(OtherServicesCharge),0) as SumOtherServicesCharge, ")
        col.Append("ISNULL(SUM(OtherFees),0) as SumOtherFees, ")
        col.Append("ISNULL(SUM(Utilities),0) as SumUtilities, ")
        col.Append("ISNULL(SUM(Water),0) as SumWater, ")
        col.Append("ISNULL(SUM(Gas_Electric),0) as SumGas_Electric, ")
        col.Append("ISNULL(SUM(AirCond_Addition),0) as SumAirCond_Addition, ")
        col.Append("ISNULL(SUM(RepairandMaintenance),0) as SumRepairandMaintenance, ")
        col.Append("ISNULL(SUM(RMOther_Fix),0) as SumRMOther_Fix, ")
        col.Append("ISNULL(SUM(RMOther_Unplan),0) as SumRMOther_Unplan, ")
        col.Append("ISNULL(SUM(RMComputer_Fix),0) as SumRMComputer_Fix, ")
        col.Append("ISNULL(SUM(RMComputer_Unplan),0) as SumRMComputer_Unplan, ")
        col.Append("ISNULL(SUM(ProfessionalFee),0) as SumProfessionalFee, ")
        col.Append("ISNULL(SUM(MarketingResearch),0) as SumMarketingResearch, ")
        col.Append("ISNULL(SUM(OtherFee),0) as SumOtherFee, ")
        col.Append("ISNULL(SUM(Equipment_MaterailandSupplies),0) as SumEquipment_MaterailandSupplies, ")
        col.Append("ISNULL(SUM(PrintingandStationery),0) as SumPrintingandStationery, ")
        col.Append("ISNULL(SUM(SuppliesExpenses),0) as SumSuppliesExpenses, ")
        col.Append("ISNULL(SUM(Equipment),0) as SumEquipment, ")
        col.Append("ISNULL(SUM(Shopfitting),0) as SumShopfitting, ")
        col.Append("ISNULL(SUM(PackagingandOtherMaterial),0) as SumPackagingandOtherMaterial, ")
        col.Append("ISNULL(SUM(BusinessTravelExpenses),0) as SumBusinessTravelExpenses, ")
        col.Append("ISNULL(SUM(CarParkingandOthers),0) as SumCarParkingandOthers, ")
        col.Append("ISNULL(SUM(Travel),0) as SumTravel, ")
        col.Append("ISNULL(SUM(Accomodation),0) as SumAccomodation, ")
        col.Append("ISNULL(SUM(MealandEntertainment),0) as SumMealandEntertainment, ")
        col.Append("ISNULL(SUM(Insurance),0) as SumInsurance, ")
        col.Append("ISNULL(SUM(AllRiskInsurance),0) as SumAllRiskInsurance, ")
        col.Append("ISNULL(SUM(HealthandLifeInsurance),0) as SumHealthandLifeInsurance, ")
        col.Append("ISNULL(SUM(PenaltyandTaxation),0) as SumPenaltyandTaxation, ")
        col.Append("ISNULL(SUM(Taxation),0) as SumTaxation, ")
        col.Append("ISNULL(SUM(Penalty),0) as SumPenalty, ")
        col.Append("ISNULL(SUM(OtherRelatedStaffCost),0) as SumOtherRelatedStaffCost, ")
        col.Append("ISNULL(SUM(StaffConferenceandTraining),0) as SumStaffConferenceandTraining, ")
        col.Append("ISNULL(SUM(Training),0) as SumTraining, ")
        col.Append("ISNULL(SUM(Communication),0) as SumCommunication, ")
        col.Append("ISNULL(SUM(TelephoneCalls_Faxes),0) as SumTelephoneCalls_Faxes, ")
        col.Append("ISNULL(SUM(PostageandCourier),0) as SumPostageandCourier, ")
        col.Append("ISNULL(SUM(OtherExpenses),0) as SumOtherExpenses, ")
        col.Append("ISNULL(SUM(Sample_Tester),0) as SumSample_Tester, ")
        col.Append("ISNULL(SUM(PreopeningCosts),0) as SumPreopeningCosts, ")
        col.Append("ISNULL(SUM(LossonClaim),0) as SumLossonClaim, ")
        col.Append("ISNULL(SUM(CashOvertage_Shortagefromsales),0) as SumCashOvertage_Shortagefromsales, ")
        col.Append("ISNULL(SUM(MiscellenousandOther),0) as SumMiscellenousandOther, ")
        col.Append("ISNULL(SUM(StoreTradingProfit__Loss),0) as SumStoreTradingProfit__Loss, ")
        'col.Append("ISNULL(SUM(TradingProfit__Loss),0) as SumTradingProfit__Loss, ")
        'col.Append("ISNULL(SUM(StoreControllableCostsforBSC),0) as SumStoreControllableCostsforBSC, ")
        'col.Append("ISNULL(SUM(StoreLabourCost),0) as SumStoreLabourCost, ")
        'col.Append("ISNULL(SUM(Utillity),0) as SumUtillity, ")
        'col.Append("ISNULL(SUM(RepairMaintenance),0) as SumRepairMaintenance, ")
        col.Append("ISNULL(SUM(SWMaintenance),0) as SumSWMaintenance, ")
        col.Append("ISNULL(SUM(HWMaintenance),0) as SumHWMaintenance, ")
        col.Append("ISNULL(SUM(ITTelecommunications),0) as SumITTelecommunications ")
        Return col.ToString
    End Function
