<%@ Page Title="" Language="VB" MasterPageFile="~/MasterPage.master" AutoEventWireup="false" CodeFile="top_store_report.aspx.vb" Inherits="top_store_report" %>
...
<asp:Content ID="Content2" ContentPlaceHolderID="ContentPlaceHolder1" Runat="Server">
    <div style="padding: 10px 10px;">
        <strong>Top Store report</strong>
        ...
        <br /><br />
         ...
         By : <asp:DropDownList ID="ddlorder" runat="server" CssClass="select2">
            <asp:ListItem Value="SumTotalRevenue">Total Revenue</asp:ListItem>
            <asp:ListItem Value="SumCostofGoodSold">Cost of Good Sold</asp:ListItem>
            <asp:ListItem Value="SumGrossProfit">Gross Profit</asp:ListItem>
            <asp:ListItem Value="SumMarginAdjustments">Margin Adjustments</asp:ListItem>
            <asp:ListItem Value="SumAdjustedGrossMargin">Adjusted Gross Margin</asp:ListItem>
            <asp:ListItem Value="SumSupplyChainCosts">Supply Chain Costs</asp:ListItem>
            <asp:ListItem Value="SumStoreLabourCosts">Store Labour Costs</asp:ListItem>
            <asp:ListItem Value="SumStorePropertyCosts">Store Property Costs</asp:ListItem>
            <asp:ListItem Value="SumDepreciation">Depreciation</asp:ListItem>
            <asp:ListItem Value="SumOtherStoreCosts">Other Store Costs</asp:ListItem>
            <asp:ListItem Value="SumStoreTradingProfit__Loss">Store Trading Profit / (Loss)</asp:ListItem>
        </asp:DropDownList>
        </div>
        <br /><br />
         <div style="float:left; margin-right:.5cm">
         Top : <asp:DropDownList ID="ddltopno" runat="server" CssClass="select2">
        ...
        <asp:DropDownList ID="ddltype" runat="server" CssClass="select2">
            <asp:ListItem Value="DESC">Profit</asp:ListItem>
            <asp:ListItem Value="ASC">Loss</asp:ListItem>
        </asp:DropDownList>
        </div>
         <div style="float:left; margin-right:.5cm">
...
<tr style='font-weight:bold;' class='kbg1'><td align='left' style='height:70px;'><div style="width:250px;padding-left:5px;"></div></td><td align='center'><div style='width:110px'><strong>Total</strong></div></td><td align='center'><div style='width:65px;'><strong>% Sale</strong></div></td></tr>
<tr style='font-weight:bold;'><td align='left' class='kbg2'><div style="width:250px;padding-left:5px;" class="pptk">Total Gross Space (sqm)</div></td><td align='center' class='kbg3'><div style='width:110px'><asp:Label ID="LbFullTgs" runat="server" Text=""></asp:Label></div></td><td align='center' class='kbg4'><div style='width:65px;'></div></td></tr>
<tr style='font-weight:bold;'><td align='left' class='kbg2'><div style="width:250px;padding-left:5px;" class="pptk">Total Selling Space (sqm)</div></td><td align='center' class='kbg3'><div style='width:110px'><asp:Label ID="LbFullTss" runat="server" Text=""></asp:Label></div></td><td align='center' class='kbg4'><div style='width:65px;'></div></td></tr>
<tr style='font-weight:bold;'><td align='left' class='kbg2'><div style="width:250px;padding-left:5px;" class="pptk">Productivity/SqM</div></td><td align='center' class='kbg3'><div style='width:110px'><asp:Label ID="LbFullPos" runat="server" Text=""></asp:Label></div></td><td align='center' class='kbg4'><div style='width:65px;'></div></td></tr>
<tr style='font-weight:bold;'><td align='left' class='kbg2'><div style="width:250px;padding-left:5px;">&nbsp;</div></td><td align='center' class='kbg3'><div style='width:110px'></div></td><td align='center' class='kbg4'><div style='width:65px;'></div></td></tr>
<tr style='font-weight:bold;' class='kbg5'><td align='left'><div style="width:200px;padding-left:5px;" class="pptk">Total Revenue <span class="ppk" onclick="minitb('aa');">+</span></div></td><td align='right'><div style='width:110px'><asp:Label ID="LbSumTotalRevenue" runat="server" Text=""></asp:Label></div></td><td align='right'><div style='width:65px;'><asp:Label ID="LbPercTotalRevenue" runat="server" Text=""></asp:Label>%</div></td></tr>
...
<tr style='font-weight:bold;' class='kbg5'><td align='left'><div style="width:200px;padding-left:5px;" class="pptk">
    Gross Retail Profit</div></td><td align='right'><div style='width:110px'><asp:Label ID="LbSumGrossProfit" runat="server" Text=""></asp:Label></div></td><td align='right'><div style='width:65px;'><asp:Label ID="LbPercGrossProfit" runat="server" Text=""></asp:Label>%</div></td></tr>
<tr style='font-weight:bold;'><td align='left' class='kbg2'><div style="width:200px;padding-left:5px;" class="pptk">Margin Adjustments <span class="ppk" onclick="minitb('b');">+</span></div></td><td align='right' class='kbg3'><div style='width:110px'><asp:Label ID="LbSumMarginAdjustments" runat="server" Text=""></asp:Label></div></td><td align='right' class='kbg4'><div style='width:65px;'><asp:Label ID="LbPercMarginAdjustments" runat="server" Text=""></asp:Label>%</div></td></tr>
...
<tr style='font-weight:bold;' class='kbg5'><td align='left'><div style="width:200px;padding-left:5px;" class="pptk">Adjusted Gross Margin</div></td><td align='right'><div style='width:110px'><asp:Label ID="LbSumAdjustedGrossMargin" runat="server" Text=""></asp:Label></div></td><td align='right'><div style='width:65px;'><asp:Label ID="LbPercAdjustedGrossMargin" runat="server" Text=""></asp:Label>%</div></td></tr>
...
<tr style='font-weight:bold;'><td align='left' class='kbg2'><div style="width:200px;padding-left:5px;" class="pptk">Store Property Costs <span class="ppk" onclick="minitb('f');">+</span></div></td><td align='right' class='kbg3'><div style='width:110px'><asp:Label ID="LbSumStorePropertyCosts" runat="server" Text=""></asp:Label></div></td><td align='right' class='kbg4'><div style='width:65px;'><asp:Label ID="LbPercStorePropertyCosts" runat="server" Text=""></asp:Label>%</div></td></tr>
...
<tr style='font-weight:bold;'><td align='left' class='kbg2'><div style="width:200px;padding-left:5px;" class="pptk">Depreciation <span class="ppk" onclick="minitb('g');">+</span></div></td><td align='right' class='kbg3'><div style='width:110px'><asp:Label ID="LbSumDepreciation" runat="server" Text=""></asp:Label></div></td><td align='right' class='kbg4'><div style='width:65px;'><asp:Label ID="LbPercDepreciation" runat="server" Text=""></asp:Label>%</div></td></tr>
...
<tr style='font-weight:bold;' class='kbg2'><td align='left'><div style="width:200px;padding-left:5px;" class="pptk">Other Store Costs <span class="ppk" onclick="minitb('h');">+</span></div></td><td align='right' class='kbg3'><div style='width:110px'><asp:Label ID="LbSumOtherStoreCosts" runat="server" Text=""></asp:Label></div></td><td align='right' class='kbg4'><div style='width:65px;'><asp:Label ID="LbPercOtherStoreCosts" runat="server" Text=""></asp:Label>%</div></td></tr>
...
<div class="scroll">
    ...
    SelectMethod="getSumFullModelByTop" TypeName="ClsDB" 
