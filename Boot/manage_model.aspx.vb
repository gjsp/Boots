...
Partial Class manage_model
    ...
    Protected Sub Imgedit_Click(ByVal sender As Object, ByVal e As System.Web.UI.ImageClickEventArgs)
        ...
        daStore = ClsDB.getStoreById(id)

        EditTxt.Text = daStore.Rows(0)("store_name").ToString
        ddlother.SelectedValue = daStore.Rows(0)("store_other").ToString
        HdID.Value = id
    ...
    Protected Sub AddBt_Click(ByVal sender As Object, ByVal e As System.EventArgs) Handles AddBt.Click
        Try
            If saveData() Then
                ClsManage.alert(Page, "Save Complete", , "manage_model.aspx")
            End If
        Catch ex As Exception
            ClsManage.alert(Page, ex.Message)
        End Try
    ...
    Function updateData() As Boolean
        Try
            ClsDB.UpdateStore(HdID.Value, EditTxt.Text, ddlother.SelectedValue)
            Return True
        Catch ex As Exception
            ClsManage.alert(Page, ex.Message)
        End Try
