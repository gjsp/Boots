<%@ Page Title="" Language="VB" MasterPageFile="~/MasterPage.master" AutoEventWireup="false" CodeFile="add_costcenter.aspx.vb" Inherits="add_costcenter" %>
...
<div style="padding:20px 0px 0px 20px;">
    <div><strong>Add Cost Center</strong><br><br></div>
...
&nbsp;<asp:ImageButton ID="ImageBt1" runat="server" ImageUrl="img/calendar-day.png" Width="20px" Height="20px"/>
    ...
    <div style="padding-top:10px;">
     ...
     <div style="padding-top:10px;">
        ...
        <div style="float:left;width:200px;padding-left:20px;">
            <asp:DropDownList ID="ddlblock" runat="server" CssClass="select2" 
                AutoPostBack="True">
    ...
    <div style="padding-top:10px;">
        ...
        <div style="float:left;width:200px;padding-left:20px;">
            ...
            <div style="float:left;">
                ...
                TargetControlID="TxtBlockdt" Format="M/yyyy" PopupButtonID="ImageButton2" >
                </cc1:CalendarExtender>
            </div>
