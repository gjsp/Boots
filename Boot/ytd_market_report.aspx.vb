...
Partial Class ytd_market_report
    Inherits basePage
 ...
 "<TR class='kbg1'><TD align='center'><div style='width:110px'><strong>" + e.Item.DataItem("market_name") + "</strong></div></TD><TD align='center'><div style='width:65px;'><strong>% Sale</strong></div></TD></TR>" + _
    ...
    "<TR style='font-weight:bold;'><TD align='center'><div style='width:110px'>" + ClsManage.convert2Currency2((e.Item.DataItem("SumTotalRevenue") / e.Item.DataItem("sumsalearea")) / Convert.ToDecimal(x_divide)).ToString + "</div></TD><TD align='center'><div style='width:65px;'>&nbsp;</div></TD></TR>" + _
