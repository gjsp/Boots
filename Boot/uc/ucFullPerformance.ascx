<%@ Control Language="VB" AutoEventWireup="false" CodeFile="ucFullPerformance.ascx.vb"
    Inherits="uc_ucFullPerformance" %>
    ...
    <div id="temp_body" runat="server">
        <table cellspacing='0' cellpadding='0' class='tb_block'>
            <tr>
                ...
                <td valign="top">
                    <div id="div_item" runat="server" class="scrollPfmFullItem">
                        <table cellspacing='0' cellpadding='0' border="0">
                            <tr>
                                <td>
                                    <table cellspacing='0' cellpadding='0' style='border-bottom: 1px solid #2c2b2b; border-right: 1px solid #2c2b2b;
                                        line-height: 14px'>
                                        <tr class='rbg0'>
                                            <td align="center" valign="top">
                                                <strong>
                                                    <br />
                                                    <br />
                                                    TOTAL(<%=ReportTopicTotal%>) Not Full Year<br />
                                                    <br />
                                                    <br />
                                                </strong>
                                            </td>
