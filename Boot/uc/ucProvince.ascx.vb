...
Partial Class uc_ucProvince
    ...
    Public Sub LoadReport(ds As Data.DataSet)
        Try
            ...
            Else
                ...
                hdfIndex.Value = 0
                lblTopicTable.Text = String.Format(clsHtml.htmlModelTopic, "Province By Store Report", "")
    ...
    Protected Sub dlItem_ItemDataBound(sender As Object, e As System.Web.UI.WebControls.DataListItemEventArgs) Handles dlItem.ItemDataBound
        ...
        Dim costcenterName As String = e.Item.DataItem("store_name").ToString
        Dim iLength As Integer = 20
        If costcenterName.Length > iLength Then
        ...
        sbHeadItem.Append(costcenterName) '0
