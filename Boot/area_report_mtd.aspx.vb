...
"<TR class='kbg1'><TD align='center'><div style='width:110px'><strong>Area " + e.Item.DataItem("area_name") + "</strong></div></TD><TD align='center'><div style='width:65px;'><strong>% Sale</strong></div></TD></TR>" + _
    ...
    "<TR style='font-weight:bold;'><TD align='center'><div style='width:110px'>" + ClsManage.convert2Currency3(e.Item.DataItem("SumTotalRevenue") / e.Item.DataItem("sumsalearea")).ToString + "</div></TD><TD align='center'><div style='width:65px;'>&nbsp;</div></TD></TR>" + _
