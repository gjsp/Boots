...
Partial Class top_store_report
    Inherits basePage
    ...
    Protected Sub SearchBt_Click(ByVal sender As Object, ByVal e As System.EventArgs) Handles SearchBt.Click
        ...
        ObjectDataSource2.SelectParameters("type").DefaultValue = ddltype.SelectedValue
        ObjectDataSource2.SelectParameters("name").DefaultValue = ddlorder.SelectedValue
        ObjectDataSource2.SelectParameters("num").DefaultValue = ddltopno.SelectedValue
